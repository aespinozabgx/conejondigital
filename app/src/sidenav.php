                    ...
                    <nav class="sidenav-menu-nested nav">
                        ...
                        else
                        {
                            ...
                            <a style="cursor: pointer;" class="nav-link" data-bs-toggle="modal" data-bs-target="#modalSeccionDePago">
                                <div class="nav-link-icon"><i class="fas fa-cash-register"></i></div>
                                Punto de venta <span class="badge bg-yellow ms-1 rounded-pill small"><i class="fa-solid fa-sm fa-star"></i></span>
                            </a>
                            <?php
                        }
                        ?>
                        ...
                        {
                            ?><a class="nav-link" href="estadisticas.php">Estadísticas</a><?php
                        }
                        else
                        {
                            ?><a style="cursor: pointer;" class="nav-link" data-bs-toggle="modal" data-bs-target="#modalSeccionDePago">Estadísticas <span class="badge bg-yellow ms-1 rounded-pill"><i class="fa-solid fa-star fa-sm"></i></span></a><?php
                        }
