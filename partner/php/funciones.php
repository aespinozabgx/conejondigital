<?php
    ...
    {
        $sql  = "SELECT DISTINCT(idTienda), nombreTienda FROM tiendas WHERE isActive = 1";
    ...
    function plantillaPedidoEnviado($idPedido)
    {
        ...
        <div align="center" class="alignment">
        <!--[if mso]><v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="https://conejondigital.com/app/detalleCompra.php?id=';
        ...
        <p style="margin: 0; font-size: 16px; text-align: center; mso-line-height-alt: 19.2px;"><span style="font-size:26px;"><strong><a href="httsp://conejondigital.com" rel="noopener" style="color: #ffffff;" target="_blank">conejondigital.com</a></strong></span><span style="font-size:18px;"><a href="httsp://conejondigital.com" rel="noopener" style="text-decoration: underline; color: #ffffff;" target="_blank"></a></span></p>
        </div>
        </div>
        </td>
        </tr>
    ...
    function plantillaOrdenConfirmada($idPedido, $fechaPedido, $reqEnvio, $direccionPedido, $subtotal, $descuento, $envio, $total, $getDatosContactoVendedor, $datosBancariosCorreo)
    {
        ...
        <h1 style="margin: 0; color: #ffffff; direction: ltr; font-family: Montserrat, Trebuchet MS, Lucida Grande, Lucida Sans Unicode, Lucida Sans, Tahoma, sans-serif; font-size: 38px; font-weight: 700; letter-spacing: normal; line-height: 120%; text-align: center; margin-top: 0; margin-bottom: 0;"><a href="conejondigital.com" rel="noopener" style="text-decoration: none; color: #ffffff;" target="_blank"><span class="tinyMce-placeholder">Conejón Digital</span></a></h1>
        </td>
        </tr>
        </table>
        ...
        <div align="left" class="alignment">
        <!--[if mso]><v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="https://conejondigital.com/app/detalleCompra.php?id='. $idPedido .'" style="height:42px;width:171px;v-text-anchor:middle;" arcsize="10%" stroke="false" fillcolor="#e17370"><w:anchorlock/><v:textbox inset="0px,0px,0px,0px"><center style="color:#ffffff; font-family:Tahoma, sans-serif; font-size:16px"><![endif]--><a href="https://conejondigital.com/app/detalleCompra.php?id='. $idPedido .'" style="text-decoration:none;display:inline-block;color:#ffffff;background-color:#e17370;border-radius:4px;width:auto;border-top:0px solid #E17370;font-weight:400;border-right:0px solid #E17370;border-bottom:0px solid #E17370;border-left:0px solid #E17370;padding-top:5px;padding-bottom:5px;font-family:Montserrat, Trebuchet MS, Lucida Grande, Lucida Sans Unicode, Lucida Sans, Tahoma, sans-serif;font-size:16px;text-align:center;mso-border-alt:none;word-break:keep-all;" target="_blank"><span style="padding-left:40px;padding-right:40px;font-size:16px;display:inline-block;letter-spacing:normal;"><span dir="ltr" style="word-break: break-word; line-height: 32px;">Ver Detalle </span></span></a>
        <!--[if mso]></center></v:textbox></v:roundrect><![endif]-->
        </div>
        </td>
        </tr>
        ...
        <p style="margin: 0;">Carga tu comprobante de pago 💰</p>
        </div>
        </td>
        </tr>
        </table>
        ...
        <div align="left" class="alignment">
        <!--[if mso]><v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="https://conejondigital.com/app/detalleCompra.php?id=' . $idPedido . '" style="height:36px;width:189px;v-text-anchor:middle;" arcsize="12%" strokeweight="0.75pt" strokecolor="#E17370" fillcolor="#e17370"><w:anchorlock/><v:textbox inset="0px,0px,0px,0px"><center style="color:#ffffff; font-family:Tahoma, sans-serif; font-size:12px"><![endif]--><a href="https://conejondigital.com/app/detalleCompra.php?id=' . $idPedido . '" style="text-decoration:none;display:inline-block;color:#ffffff;background-color:#e17370;border-radius:4px;width:auto;border-top:1px solid #E17370;font-weight:400;border-right:1px solid #E17370;border-bottom:1px solid #E17370;border-left:1px solid #E17370;padding-top:5px;padding-bottom:5px;font-family:Montserrat, Trebuchet MS, Lucida Grande, Lucida Sans Unicode, Lucida Sans, Tahoma, sans-serif;font-size:12px;text-align:center;mso-border-alt:none;word-break:keep-all;" target="_blank"><span style="padding-left:30px;padding-right:30px;font-size:12px;display:inline-block;letter-spacing:normal;"><span dir="ltr" style="word-break: break-word; line-height: 24px;">Cargar comprobante</span></span></a>
        <!--[if mso]></center></v:textbox></v:roundrect><![endif]-->
        </div>
        </td>
        </tr>
        ...
        <p style="margin: 0;">
            Vendedor: ' . 
            (isset($getDatosContactoVendedor['nombre']) ? $getDatosContactoVendedor['nombre'] : '')
            . '
        </p>
        </div>
        </td>
                                                                        ...
                                                                        <div class="" style="font-size: 12px; mso-line-height-alt: 18px; color: #666666; line-height: 1.5; font-family: Montserrat, Trebuchet MS, Lucida Grande, Lucida Sans Unicode, Lucida Sans, Tahoma, sans-serif;">
                                                                                <p style="margin: 0; font-size: 14px; text-align: left; mso-line-height-alt: 21px;">
                                                                                        <span style="font-size:14px; color:red;">
                                                                                                <s> $ ' . (isset($descuento) ? number_format($descuento, 2) : '') . ' </s>
                                                                                        </span>
                                                                                </p>
                                                                        </div>
                                                                </div>
        ...
        <div style="font-family: sans-serif">
        <div class="" style="font-size: 12px; mso-line-height-alt: 18px; color: #ffffff; line-height: 1.5; font-family: Montserrat, Trebuchet MS, Lucida Grande, Lucida Sans Unicode, Lucida Sans, Tahoma, sans-serif;">
        <p style="margin: 0; font-size: 14px; text-align: center; mso-line-height-alt: 24px;"><span style="font-size:16px;">Gracias por usar <span style="color:#ffffff;"><a href="https://conejondigital.com" rel="noopener" style="text-decoration: none; color: #ffffff;" target="_blank"><strong>conejondigital.com</strong></a></span><span style="background-color:#ffffff;"><a href="https://conejondigital.com" rel="noopener" style="text-decoration: none; background-color: #ffffff; color: #ffffff;" target="_blank"></a></span></span></p>
        </div>
        </div>
        </td>
        </tr>
        ...
        <div align="left" class="alignment">
        <!--[if mso]><v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="https://conejondigital.com/#registro" style="height:44px;width:188px;v-text-anchor:middle;" arcsize="10%" strokeweight="0.75pt" strokecolor="#E17370" fillcolor="#e17370"><w:anchorlock/><v:textbox inset="0px,0px,0px,0px"><center style="color:#ffffff; font-family:Tahoma, sans-serif; font-size:16px"><![endif]--><a href="https://conejondigital.com/#registro" style="text-decoration:none;display:inline-block;color:#ffffff;background-color:#e17370;border-radius:4px;width:auto;border-top:1px solid #E17370;font-weight:400;border-right:1px solid #E17370;border-bottom:1px solid #E17370;border-left:1px solid #E17370;padding-top:5px;padding-bottom:5px;font-family:Montserrat, Trebuchet MS, Lucida Grande, Lucida Sans Unicode, Lucida Sans, Tahoma, sans-serif;font-size:16px;text-align:center;mso-border-alt:none;word-break:keep-all;" target="_blank"><span style="padding-left:30px;padding-right:30px;font-size:16px;display:inline-block;letter-spacing:normal;"><span dir="ltr" style="word-break: break-word; line-height: 32px;">Crear mi tienda</span></span></a>
        <!--[if mso]></center></v:textbox></v:roundrect><![endif]-->
        </div>
        </td>
        </tr>
    ...
    function getDatosContactoVendedor($conn, $idTienda)
    {
        ...
        FROM `usuarios`
        INNER JOIN tiendas
        ON usuarios.email = tiendas.administradoPor
        WHERE usuarios.isActive = 1 AND tiendas.isActive = 1 AND tiendas.idTienda = '$idTienda'";
        ...
        if (mysqli_num_rows($result) > 0)
        {
            ...
            while ($row = mysqli_fetch_assoc($result))
            {
                ...
                $datos['nombre']    = $row['idTienda'];
                $datos['paterno']   = $row['nombreTienda'];
                $datos['materno']   = $row['administradoPor'];
                $datos['telefono']  = $row['nombre'];
                $datos['email']     = $row['paterno'];
                $datos['username']  = $row['telefono'];
    ...
    function getDireccionPedido($conn, $idEnvio, $idDireccionEnvio, $idCliente, $idVendedor)
    {
        ...
        if ($consultaDB)
        {
            ...
            if ($recolectarSucursal)
            {
                $sql = "SELECT * FROM sucursalesTiendas WHERE idTienda = '$idTienda' AND idDireccion = '$idDireccionEnvio'";
            }
            else
            {
                $sql = "SELECT * FROM direccionesClientes  WHERE idCliente = '$idCliente' AND idDireccion = '$idDireccionEnvio'";
    ...
    function getDatosTienda($conn, $idTienda)
    {
        ...
        $sql = "SELECT * FROM tiendas WHERE idTienda = '$idTienda' AND isActive =1";
    ...
    function getMiembrosTienda($conn, $idTienda)
    {
        // Creamos la consulta SQL base
        $sql = "SELECT * FROM tiendas WHERE idTienda = '$idTienda' AND isActive = 1";
        ...
        // Creamos un array para almacenar todos los datos
        $datosTienda = array();
        ...
        // Retornamos el array con todos los datos
        return $datosTienda;
    }
