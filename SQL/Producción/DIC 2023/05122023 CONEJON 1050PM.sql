...
-- Tiempo de generación: 06-12-2023 a las 04:50:22
...
--
-- Volcado de datos para la tabla `bitacoraCaja`
--

INSERT INTO `bitacoraCaja` (`id`, `idTienda`, `idUsuario`, `fechaApertura`, `fechaCierre`, `efectivoInicial`, `totalEfectivoEnCaja`, `efectivoFinal`) VALUES
(1, 'conejondigital', 'axelcoreos@gmail.com', '2023-11-23 00:03:35', '2023-11-23 00:04:07', '0.00', 0, '0.00'),
(2, 'conejondigital', 'axelcoreos@gmail.com', '2023-11-23 00:04:18', NULL, '0.00', 0, NULL),
(3, 'mamaconeja', 'gabriela.rios.h@hotmail.com', '2023-11-23 03:50:58', NULL, '0.00', 0, NULL);
...
CREATE TABLE `categoriasTienda` (
  `id` int(11) NOT NULL,
  `idCategoria` varchar(128) CHARACTER SET utf8 COLLATE utf8_spanish_ci NOT NULL,
  `nombre` varchar(33) CHARACTER SET utf8 COLLATE utf8_spanish_ci NOT NULL,
  `idTienda` varchar(200) CHARACTER SET utf8 COLLATE utf8_spanish_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;

--
-- Volcado de datos para la tabla `categoriasTienda`
--

INSERT INTO `categoriasTienda` (`id`, `idCategoria`, `nombre`, `idTienda`) VALUES
(1, 'f11ef3c87a96924ffc3bf368db3e', 'accesorios', 'mamaconeja'),
(2, 'eaa089fa5defa0031a3991ab17dc', 'heno', 'picoslocos'),
(3, 'e571547d30811d95aec0e69990fb', 'abarrotes', 'conejondigital'),
(4, 'ae6434d035fa629d9dac31ecf5fa', 'heneras', 'picoslocos'),
(5, 'd92e6b3a10748fc3861bdba5af65', 'esquineros', 'picoslocos'),
(6, '52d4ebc60f5db74e2b9c8c7e9c3b', 'juguetes', 'picoslocos'),
(7, '5cf93825dad202feacfae159121d', 'comederos/bebederos', 'picoslocos');
...
--
-- Estructura de tabla para la tabla `CAT_mediosContacto`
--

CREATE TABLE `CAT_mediosContacto` (
  `id` int(11) NOT NULL,
  `idMediosContacto` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
--
-- Estructura de tabla para la tabla `CAT_tipoEnvio`
--

CREATE TABLE `CAT_tipoEnvio` (
  `id` int(11) NOT NULL,
  `idEnvio` varchar(15) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `nombre` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `isActive` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
--
-- Estructura de tabla para la tabla `CAT_tipoPedido`
--

CREATE TABLE `CAT_tipoPedido` (
  `id` int(11) NOT NULL,
  `idTipoPedido` varchar(15) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `nombre` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `isActive` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;

--
-- Volcado de datos para la tabla `CAT_tipoPedido`
--

INSERT INTO `CAT_tipoPedido` (`id`, `idTipoPedido`, `nombre`, `isActive`) VALUES
(1, 'WEB', 'En línea', 1),
(2, 'PDV', 'Punto De Venta', 1);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `contactotiendas`
--

CREATE TABLE `contactotiendas` (
  `id` int(11) NOT NULL,
  `idTienda` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `idMediosContacto` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `data` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `isPublicOnline` tinyint(1) NOT NULL DEFAULT 1,
...
--
-- Volcado de datos para la tabla `enviosTiendas`
--

INSERT INTO `enviosTiendas` (`id`, `idTipoEnvio`, `idTienda`, `nombreEnvio`, `precioEnvio`, `hasOnlinePayment`, `hasDeliveryPayment`, `isActive`) VALUES
(1, 'PIK', 'picoslocos', 'Pick Up Sucursal', 0, 1, 1, 1);
...
(15, 'dash230216@gmail.com', 'Susana Osorio ', '5582280606', 'Picos Locos ', 'Productos para mascota ', '', '', NULL),
(16, 'usagisnack23@gmail.com', 'Laura Berenice Resendiz Rodríguez ', '5561461218', 'Usagi Snack', 'Snack para conejitos, accesorios y productos para humanos', '', '', NULL),
(17, 'yourmail@gmail.com', 'MikhailRS', '8220257544', 'MikhailRS', 'Hello. I will increase traffic and profitability of the site, and also solve all the problems existing on the site. Moreover, the increase in traffic will be due to the influx of targeted visitors from search engines, which is the most profitable and prom', '', '', NULL),
(18, 'kass.soad@gmail.com', 'Kasandra Salguero Martínez', '5523147210', 'Fisgoncitos', 'Arte de mascotas, retratos personalizados.', '', '', NULL),
(19, 'aikirita.pat@gmail.com', 'Alejandra Yetlanezi Juarez Vidal', '5530700661', 'ConejoManía ', 'Artículos con temática de conejitos ', '', '', NULL),
(20, 'lenaandrews1981@gmail.com', 'Lena Andrews', '0339 66267', 'Lena Andrews', 'Hi, I noticed a few issues on your website, when do you a have second to go over them?', '', '', NULL),
(21, 'septon36giannixi@gmail.com', 'Philcliny', '5741140753', 'Philcliny', 'Γεια σου, ήθελα να μάθω την τιμή σας.', '', '', NULL);
...
CREATE TABLE `imagenProducto` (
  `id` int(11) NOT NULL,
  `idProducto` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `idTienda` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `url` varchar(2000) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `isPrincipal` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
INSERT INTO `imagenProducto` (`id`, `idProducto`, `idTienda`, `url`, `isPrincipal`) VALUES
(2, 'P-3', 'conejondigital', 'P-3_96127cc2.jpg', 1),
(3, 'P-2', 'picoslocos', '1.jpeg', 0),
(4, 'P-2', 'picoslocos', '2.jpeg', 1),
(5, 'P-1', 'picoslocos', '1.jpeg', 0),
(6, 'P-1', 'picoslocos', '2.jpeg', 0),
(7, 'P-1', 'picoslocos', '3.jpeg', 1),
(8, 'P-4', 'picoslocos', 'P-4_b794decb.jpeg', 0),
(9, 'P-4', 'picoslocos', 'P-4_670d7a79.jpeg', 1),
(10, 'P-5', 'picoslocos', 'P-5_56d35914.jpeg', 0),
(11, 'P-5', 'picoslocos', 'P-5_dfa05788.jpeg', 1),
(12, 'P-6', 'picoslocos', 'P-6_dffc2de1.jpeg', 0),
(13, 'P-6', 'picoslocos', 'P-6_46698c9b.jpeg', 1),
(14, 'P-7', 'picoslocos', 'P-7_0c43fddc.jpeg', 0),
(15, 'P-7', 'picoslocos', 'P-7_c8b06e76.jpeg', 1),
(16, 'P-8', 'picoslocos', 'P-8_c0f2e5ad.jpeg', 0),
(17, 'P-8', 'picoslocos', 'P-8_01f65f10.jpeg', 1),
(18, 'P-9', 'picoslocos', 'P-9_267bc67c.jpeg', 0),
(19, 'P-9', 'picoslocos', 'P-9_61accc31.jpeg', 0),
(20, 'P-9', 'picoslocos', 'P-9_3b36ace6.jpeg', 1),
(21, 'P-10', 'picoslocos', 'P-10_5180dd00.png', 0),
(22, 'P-10', 'picoslocos', 'P-10_b06f7811.jpeg', 0),
(23, 'P-10', 'picoslocos', 'P-10_676b8774.jpeg', 0),
(24, 'P-10', 'picoslocos', 'P-10_d9f6645d.jpeg', 0),
(25, 'P-10', 'picoslocos', 'P-10_6ccabced.jpeg', 0),
(26, 'P-10', 'picoslocos', 'P-10_7eeb77a8.jpeg', 1),
(27, 'P-11', 'picoslocos', 'P-11_47af7014.jpeg', 1),
(28, 'P-12', 'picoslocos', 'P-12_d07b29b4.jpeg', 0),
(29, 'P-12', 'picoslocos', 'P-12_d4db00a9.jpeg', 1);
...
(121, 'MSP118', 'foto.jpg', 'segurosjst@gmail.com', 'Manchitas', '2023-02-12', 'Enano holandés ', 'Macho', 'Blanco con negro', 0, 1),
...
(141, 'MSP138', 'foto.jpeg', 'dianucha99@gmail.com', 'Anakin ', '2022-01-20', 'Cabeza de León ', 'Macho', 'Blanco con café, negro y gris ', 0, 1),
...
(168, 'MSP164', 'foto.jpg', 'montserrat.ortega.r@gmail.com', 'Haru', '2021-04-30', 'Belier', 'Macho', 'Blanco con manchas grises', 0, 1),
...
(255, 'MSP250', 'foto.jpg', 'fcpalafoxpsic@hotmail.com', 'Taquito ', '2021-10-03', 'Rex', 'Macho', 'Café tostadito', 0, 1),
(256, 'MSP251', 'foto.jpg', 'fcpalafoxpsic@hotmail.com', 'Petotina gordita', '2021-10-03', 'Rex', 'Hembra', 'Blanco con motitas negras', 0, 1),
...
(273, 'MSP268', 'foto.jpg', 'carrilloanalilia0@gmail.com', 'Ate', '2022-12-12', 'Cabeza de león', 'Macho', 'Blanco con manchas negras y grises', 0, 1),
...
(296, 'MSP291', 'foto.jpeg', 'montsemdk@hotmail.com', 'Poli', '2019-12-14', 'Mini Rex', 'Macho', 'Gris', 0, 1),
...
(343, 'MSP337', 'foto.jpeg', 'betty.grcavila@gmail.com', 'Leonora', '2023-06-17', 'Blanco de Hotot', 'Hembra', 'Blanco, negro y café', 0, 1),
...
(370, 'MSP364', 'foto.jpg', 'jessly2018@yahoo.com', 'Antonella ', '2023-04-15', NULL, NULL, NULL, 0, 1),
(371, 'MSP365', 'foto.jpg', 'jessly2018@yahoo.com', 'Amanda ', '2023-05-15', NULL, NULL, NULL, 0, 1),
(372, 'MSP366', 'foto.jpg', 'kkatyvane@gmail.com', 'Bocchi', '2022-08-11', NULL, NULL, NULL, 0, 1),
(373, 'MSP367', 'foto.jpg', 'valeriathaliaperezestevez@gmail.com', 'Bigotes ', '2023-07-30', NULL, NULL, NULL, 0, 1),
(374, 'MSP368', 'foto.jpeg', 'ednaalbamorales@gmail.com', 'Darwin', '2020-02-01', NULL, NULL, NULL, 0, 1),
(375, 'MSP369', 'foto.jpeg', 'ednaalbamorales@gmail.com', 'Molly', '2021-03-01', NULL, NULL, NULL, 0, 1),
(376, 'MSP370', 'foto.jpg', 'danielatorres.cienciayvino@gmail.com', 'Cupido', '2018-02-14', 'Belier', 'Macho', 'Negro', 0, 1),
(377, 'MSP371', 'foto.jpg', 'senekismarin@gmail.com', 'Rabino ', '2021-07-17', NULL, NULL, NULL, 0, 1),
(378, 'MSP372', 'foto.jpg', 'senekismarin@gmail.com', 'Chiqui', '2021-07-17', NULL, NULL, NULL, 0, 1),
(379, 'MSP373', 'foto.jpg', 'senekismarin@gmail.com', 'Gordito', '2021-07-17', NULL, NULL, NULL, 0, 1),
(380, 'MSP374', 'foto.jpeg', 'diaragones@icloud.com', 'Powder', '2021-02-23', NULL, NULL, NULL, 0, 1),
(381, 'MSP375', 'foto.jpeg', 'e_stay_09@naver.com', 'Manzano', '2023-10-12', 'cabeza de leon', 'Macho', 'blanco con manchas grises ', 0, 1),
(382, 'MSP376', 'foto.jpeg', 'e_stay_09@naver.com', 'Mazapán', '2023-11-18', 'mini lop', 'Hembra', 'café claro', 0, 1),
(383, 'MSP377', 'foto.png', 'lolite.s.m@hotmail.com', 'Bruno', '2023-02-14', NULL, NULL, NULL, 0, 1),
(384, 'MSP378', 'foto.jpg', 'araujo.urrutia@gmail.com', 'Basil', '2023-07-30', 'Rex', 'Macho', 'Miel con blanco', 0, 1),
(385, 'MSP379', 'foto.jpg', 'araujo.urrutia@gmail.com', 'Coquita', '2023-07-30', NULL, NULL, NULL, 0, 1),
(386, 'MSP380', 'foto.jpg', 'araujo.urrutia@gmail.com', 'Gabriel', '2023-02-16', 'Rex', 'Macho', 'Negro', 0, 1),
(387, 'MSP381', 'foto.jpg', 'araujo.urrutia@gmail.com', 'Cocoa', '2023-02-16', 'Rex', 'Hembra', 'Blanco con cafe', 0, 1),
(388, 'MSP382', 'foto.jpg', 'yola_chan@hotmail.com', 'Coco', '2019-07-19', 'Mini rex', 'Macho', 'Gris', 0, 1),
(389, 'MSP383', 'foto.jpeg', 'jessie_hoa@hotmail.com', 'Boli', '2023-07-01', 'Cabeza de leon', 'Hembra', 'Gris ', 0, 1),
(390, 'MSP384', 'foto.jpeg', 'jackie_jmj@live.com', 'Bonitila', '2021-11-01', NULL, NULL, NULL, 0, 1),
(391, 'MSP385', 'foto.jpeg', 'jackie_jmj@live.com', 'Bonitila', '2021-11-01', 'Mini lop belier', 'Hembra', 'Café con blanco', 0, 1),
(392, 'MSP386', 'foto.jpg', 'aliferta31@gmail.com', 'Tambor ', '2021-12-05', NULL, NULL, NULL, 0, 1),
(393, 'MSP387', 'foto.jpg', 'seltran@hotmail.com', 'Mixu', '2020-12-21', NULL, NULL, NULL, 0, 1),
(394, 'MSP388', 'foto.jpg', 'fmartinez.andrade0@gmail.com', 'Haru', '2021-04-30', 'Belier', 'Macho', 'Blanco', 0, 1),
(395, 'MSP389', 'foto.jpeg', 'luna.gonzalez.ofe@gmail.com', 'Porfirio', '2021-02-06', NULL, NULL, NULL, 0, 1),
(396, 'MSP390', 'foto.jpg', 'manuel131297@gmail.com', 'Panda', '2021-04-16', 'Mariposa', 'Macho', 'Blanco y negro', 0, 1),
(397, 'MSP391', 'foto.jpg', 'robert_82_26@hotmail.com', 'LULA', '2023-09-23', NULL, NULL, NULL, 0, 1),
(398, 'MSP392', 'foto.jpg', 'andrea.taylor.munguia@gmail.com', 'Conejin', '2021-04-12', NULL, NULL, NULL, 0, 1),
(399, 'MSP393', 'foto.jpg', 'andrea.taylor.munguia@gmail.com', 'Kolithas', '2021-01-20', NULL, NULL, NULL, 0, 1),
(400, 'MSP394', 'foto.jpg', 'araujo.urrutia@gmail.com', 'Coquito', '2023-07-30', 'Rex', 'Macho', 'Cafe', 0, 1),
(401, 'MSP395', 'foto.jpg', 'eclipse_ec17@hotmail.com', 'Luna', '2022-12-07', NULL, NULL, NULL, 0, 1),
(402, 'MSP396', 'foto.jpg', 'asda.p9.fm@outlook.com', 'Chúchus ', '2023-07-03', 'Belier', 'Hembra', 'Miel', 0, 1),
(403, 'MSP397', 'foto.jpg', 'gcrgaby584@gmail.com', 'Pocholata', '2023-10-20', NULL, NULL, NULL, 0, 1),
(404, 'MSP398', 'foto.jpeg', 'avilabelloviridiana@gmail.com', 'Aiko', '2022-11-20', NULL, NULL, NULL, 0, 1),
(405, 'MSP399', 'foto.jpeg', 'quetzal2405@hotmail.com', 'Beethoven', '2022-08-20', NULL, NULL, NULL, 0, 1),
(406, 'MSP400', 'foto.jpg', 'itzel0503_05@hotmail.com', 'Towi Shasho', '2016-07-17', NULL, NULL, NULL, 0, 1),
(407, 'MSP401', 'foto.jpg', 'lutthmila@gmail.com', 'Mandarina', '2022-11-29', 'Alaska ', '', 'Café ', 0, 1),
(408, 'MSP402', 'foto.jpg', 'Fr7593100@gmail.com', 'Carlitos', '2021-12-18', NULL, NULL, NULL, 0, 1),
(409, 'MSP403', 'foto.jpg', 'mark2012uwu@gmail.com', 'Titi ', '2022-06-07', NULL, NULL, NULL, 0, 1),
(410, 'MSP404', 'foto.jpg', 'bluemayu1407@gmail.com', 'Honey', '2023-06-16', NULL, NULL, NULL, 0, 1),
(411, 'MSP405', 'foto.jpg', 'bluemayu1407@gmail.com', 'Luna', '2023-08-11', NULL, NULL, NULL, 0, 1),
(412, 'MSP406', 'foto.jpg', 'bemb2802@gmail.com', 'Bombon', '2023-02-01', NULL, NULL, NULL, 0, 1),
(413, 'MSP407', 'foto.jpg', 'fernandaalvarez164kz@gmail.com', 'Ayland', '2022-08-15', NULL, NULL, NULL, 0, 1),
(414, 'MSP408', 'foto.jpg', 'analilia.ruiz20@gmail.com', 'Taro', '2021-10-28', NULL, NULL, NULL, 0, 1),
(415, 'MSP409', 'foto.jpg', 'analilia.ruiz20@gmail.com', 'Cuco', '2021-10-28', NULL, NULL, NULL, 0, 1),
(416, 'MSP410', 'foto.jpeg', 'limaroma1966@gmail.com', 'Mel', '2019-01-18', NULL, NULL, NULL, 0, 1),
(417, 'MSP411', 'foto.jpeg', 'limaroma1966@gmail.com', 'Lola', '2019-03-20', NULL, NULL, NULL, 0, 1),
(418, 'MSP412', 'foto.jpeg', 'julio_cdc@outlook.com', 'Bruno César de La Cruz Xochihua', '2022-04-03', 'Belier', 'Macho', 'Café ', 0, 1),
(419, 'MSP413', 'foto.jpeg', 'tanylizeth006@gmail.com', 'Púa', '2022-11-11', NULL, NULL, NULL, 0, 1),
(420, 'MSP414', 'foto.jpeg', 'herediaobed.derecho@gmail.com', 'Nita', '2022-09-14', NULL, NULL, NULL, 0, 1),
(421, 'MSP415', 'foto.jpg', 'maria.fernanda.omemartinez@bggem.mx', 'Werita', '2020-04-09', NULL, NULL, NULL, 0, 1),
(422, 'MSP416', 'foto.jpg', 'mariibalmar@gmail.com', 'Negri', '2021-07-05', NULL, NULL, NULL, 0, 1),
(423, 'MSP417', 'foto.jpg', 'balderasmari231199@gmail.com', 'Canely', '2022-01-07', 'Lop-cabeza de leon', 'Macho', 'Cafe', 0, 1),
(424, 'MSP418', 'foto.jpg', 'jsr1_gaviota@hotmail.com', 'Gorda', '2019-06-08', 'Criolla', 'Hembra', 'Blanco cafe', 0, 1),
(425, 'MSP419', 'foto.jpg', 'michellmarilyn777@gmail.com', 'Cabritas', '2022-04-04', NULL, NULL, NULL, 0, 1),
(426, 'MSP420', 'foto.jpg', 'massielmejia99@gmail.com', 'Kobi', '2020-07-19', NULL, NULL, NULL, 0, 1),
(427, 'MSP421', 'foto.jpg', 'ursulaconeja@gmail.com', 'Ivonne', '2019-12-10', 'California ', 'Hembra', 'Blanco', 0, 1),
(428, 'MSP422', 'foto.jpg', 'ursulaconeja@gmail.com', 'Pepe', '2016-01-14', 'Cabeza de leon', 'Macho', 'Gris', 0, 1),
(429, 'MSP423', 'foto.jpeg', 'diegosandovalgr282@gmail.com', 'Ciri', '2023-02-14', NULL, NULL, NULL, 0, 1);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `metodosdepagotienda`
--

CREATE TABLE `metodosdepagotienda` (
  `id` int(11) NOT NULL,
  `idMetodoDePago` varchar(15) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `nombreMP` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `idTienda` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `urlPago` varchar(1000) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `banco` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `numeroTarjeta` varchar(19) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `clabe` varchar(18) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `beneficiario` varchar(228) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `isActive` tinyint(1) NOT NULL DEFAULT 1
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
INSERT INTO `payments` (`id`, `pagadoPor`, `idTienda`, `montoPago`, `fechaInicioPlan`, `fechaFinPlan`) VALUES
(1, 'dash230216@gmail.com', 'picoslocos', '1000.00', '2023-11-01 22:12:25', '2024-03-01 22:12:25'),
(2, 'gabriela.rios.h@hotmail.com', 'mamaconeja', '1000.00', '2023-11-01 22:12:25', '2024-03-01 22:12:25'),
(3, 'axelcoreos@gmail.com', 'conejondigital', '1000.00', '2023-11-01 22:12:25', '2024-03-01 22:12:25');
...
CREATE TABLE `pedidos` (
  ...
  `validacionPago` tinyint(1) DEFAULT NULL,
  `fechaValidacionPago` datetime DEFAULT NULL,
...
INSERT INTO `pedidos` (`id`, `idPedido`, `idCliente`, `idVendedor`, `fechaPedido`, `idTipoPedido`, `idSucursalVenta`, `idTienda`, `requiereEnvio`, `idTipoEnvio`, `direccionEnvio`, `fechaEnvio`, `guiaEnvio`, `paqueteriaEnvio`, `precioEnvio`, `fechaPago`, `idMetodoDePago`, `comprobantePago`, `validacionPago`, `fechaValidacionPago`, `fechaCierrePedido`, `idEstatusPedido`, `idCodigoPromocional`, `descuentoCodigoPromocional`, `subtotal`, `descuentos`, `total`, `isActive`) VALUES
(5, 'CD1', 'axelcoreos@gmail.com', NULL, '2023-11-09 02:53:57', 'WEB', NULL, 'mamaconeja', NULL, 'PIK', 'Dirección de usuario 88', NULL, NULL, NULL, 0, '2023-11-27 18:24:52', 'spinOxxo', 'comprobantePago.jpg', NULL, NULL, NULL, 'EP-2', NULL, NULL, 270, 0, 270, 0),
(6, 'CD2', 'gabriela.rios.h@hotmail.com', NULL, '2023-11-09 09:40:22', 'WEB', NULL, 'mamaconeja', NULL, 'PIK', 'Dirección de usuario 88', '2023-12-09 00:00:00', 'CD3', 'Tu producto será entregado en la entrada del Huerto, el día que nos acompañes al CONEJON. Gracias por tu preferencia.', 0, '2023-12-04 00:00:00', 'transferenciaBancaria', 'comprobantePago.jpg', 1, '2023-12-05 18:15:41', '2023-12-04 11:47:10', 'EP-2', NULL, NULL, 90, 0, 90, 1),
(7, 'CD3', 'peraltahannia25@gmail.com', NULL, '2023-11-11 22:26:25', 'WEB', NULL, 'mamaconeja', NULL, 'PIK', 'Dirección de usuario 88', '2023-12-09 00:00:00', 'CD3', 'Se entregará tu paquete en la entrada del CONEJON', 0, '2023-11-11 22:32:26', 'transferenciaBancaria', 'comprobantePago.jpeg', NULL, NULL, NULL, 'EP-3', NULL, NULL, 90, 0, 90, 1),
(8, 'CD4', 'ale.olmos.140384@gmail.com', NULL, '2023-11-16 11:46:11', 'WEB', NULL, 'mamaconeja', NULL, 'PIK', 'Dirección de usuario 88', NULL, NULL, NULL, 0, NULL, 'spinOxxo', NULL, NULL, NULL, NULL, 'EP-1', NULL, NULL, 180, 0, 180, 1),
(9, 'CD5', 'lic.nut.alondrasanchez@gmail.com', NULL, '2023-11-16 11:49:23', 'WEB', NULL, 'mamaconeja', NULL, 'PIK', 'Dirección de usuario 88', '2023-12-09 00:00:00', 'CD5', 'Se entregará tu producto en la entrada del  Huerto, los días del CONEJON. Muchas gracias por tu compra', 0, '2023-11-16 11:51:34', 'transferenciaBancaria', 'comprobantePago.png', NULL, NULL, NULL, 'EP-3', NULL, NULL, 90, 0, 90, 1),
(10, 'CD6', 'bernalsara14@gmail.com', NULL, '2023-11-16 12:38:52', 'WEB', NULL, 'mamaconeja', NULL, 'PIK', 'Dirección de usuario 88', '2023-12-09 00:00:00', 'CD6', 'Tu producto será entregado en la entrada del Huerto, el día que nos acompañes al CONEJON. Gracias por tu preferencia.', 0, '2023-11-16 12:42:35', 'transferenciaBancaria', 'comprobantePago.png', NULL, NULL, NULL, 'EP-3', NULL, NULL, 90, 0, 90, 1),
(11, 'CD7', 'axelcoreos@gmail.com', NULL, '2023-11-16 14:36:39', 'WEB', NULL, 'mamaconeja', NULL, 'PIK', 'Dirección de usuario 88', NULL, NULL, NULL, 0, NULL, 'transferenciaBancaria', NULL, NULL, NULL, NULL, 'EP-1', NULL, NULL, 90, 0, 90, 0),
(12, 'CD8', 'g.galvezabrego@gmail.com', NULL, '2023-11-16 23:52:18', 'WEB', NULL, 'mamaconeja', NULL, 'PIK', 'Dirección de usuario 88', NULL, NULL, NULL, 0, NULL, 'transferenciaBancaria', NULL, NULL, NULL, NULL, 'EP-1', NULL, NULL, 90, 0, 90, 1),
(13, 'CD9', 'espectro.azteca@gmail.com', NULL, '2023-11-17 03:02:11', 'WEB', NULL, 'mamaconeja', NULL, 'PIK', 'Dirección de usuario 88', NULL, NULL, NULL, 0, NULL, 'transferenciaBancaria', NULL, NULL, NULL, NULL, 'EP-1', NULL, NULL, 90, 0, 90, 1),
(14, 'CD10', 'espectro.azteca@gmail.com', NULL, '2023-11-17 03:07:22', 'WEB', NULL, 'mamaconeja', NULL, 'PIK', 'Dirección de usuario 88', NULL, NULL, NULL, 0, '2023-11-17 03:07:33', 'transferenciaBancaria', 'comprobantePago.jpg', NULL, NULL, NULL, 'EP-2', NULL, NULL, 90, 0, 90, 1),
(15, 'CD11', 'fati_rdz0710@outlook.com', NULL, '2023-11-19 09:02:24', 'WEB', NULL, 'mamaconeja', NULL, 'PIK', 'Dirección de usuario 88', NULL, NULL, NULL, 0, NULL, 'transferenciaBancaria', NULL, NULL, NULL, NULL, 'EP-1', NULL, NULL, 90, 0, 90, 1),
(16, 'CD12', 'g.galvezabrego@gmail.com', NULL, '2023-11-20 22:04:04', 'WEB', NULL, 'mamaconeja', NULL, 'PIK', 'Dirección de usuario 88', '2023-12-09 00:00:00', 'CD12', 'Tu producto será entregado en la entrada del Huerto, el día que nos acompañes al CONEJON. Gracias por tu preferencia.', 0, '2023-11-20 22:07:03', 'transferenciaBancaria', 'comprobantePago.jpg', NULL, NULL, NULL, 'EP-3', NULL, NULL, 90, 0, 90, 1),
(17, 'CD13', 'lilusamano@gmail.com', NULL, '2023-11-20 23:50:52', 'WEB', NULL, 'mamaconeja', NULL, 'PIK', 'Dirección de usuario 88', NULL, NULL, NULL, 0, NULL, 'spinOxxo', NULL, NULL, NULL, NULL, 'EP-1', NULL, NULL, 90, 0, 90, 1),
(18, 'CD14', 'abigailromeroh@gmail.com', NULL, '2023-11-23 18:29:06', NULL, NULL, 'mamaconeja', NULL, 'PIK', 'Dirección de usuario 88', NULL, NULL, NULL, 0, NULL, 'spinOxxo', NULL, NULL, NULL, NULL, 'EP-1', NULL, NULL, 90, 0, 90, 1),
(19, 'CD15', 'jazmin.eacj@gmail.com', NULL, '2023-11-23 20:57:15', NULL, NULL, 'mamaconeja', NULL, 'PIK', 'Dirección de usuario 88', NULL, NULL, NULL, 0, NULL, 'transferenciaBancaria', NULL, NULL, NULL, NULL, 'EP-1', NULL, NULL, 90, 0, 90, 1),
(20, 'CD16', 'dianucha99@gmail.com', NULL, '2023-11-23 23:37:38', NULL, NULL, 'mamaconeja', NULL, 'PIK', 'Dirección de usuario 88', '2023-12-09 00:00:00', 'CD16', 'Tu producto será entregado en la entrada del Huerto, el día que nos acompañes al CONEJON. Gracias por tu preferencia.', 0, '2023-11-23 23:51:10', 'transferenciaBancaria', 'comprobantePago.jpeg', NULL, NULL, NULL, 'EP-3', NULL, NULL, 90, 0, 90, 1),
(21, 'CD17', 'lolite.s.m@hotmail.com', NULL, '2023-11-25 09:49:50', NULL, NULL, 'mamaconeja', NULL, 'PIK', 'Dirección de usuario 88', NULL, NULL, NULL, 0, NULL, 'transferenciaBancaria', NULL, NULL, NULL, NULL, 'EP-1', NULL, NULL, 90, 0, 90, 1),
(22, 'CD18', 'cortesjimenezm65@gmail.com', NULL, '2023-11-26 10:32:50', NULL, NULL, 'mamaconeja', NULL, 'PIK', 'Dirección de usuario 88', NULL, NULL, NULL, 0, NULL, 'transferenciaBancaria', NULL, NULL, NULL, NULL, 'EP-1', NULL, NULL, 90, 0, 90, 1),
(23, 'CD19', 'sparklylollipop05@gmail.com', NULL, '2023-11-27 09:35:04', NULL, NULL, 'mamaconeja', NULL, 'PIK', 'Dirección de usuario 88', '2023-12-09 00:00:00', 'CD19', 'Se entregará tu producto en la entrada del  Huerto, los días del CONEJON. Muchas gracias por tu compra', 0, '2023-11-27 09:44:14', 'transferenciaBancaria', 'comprobantePago.jpg', NULL, NULL, NULL, 'EP-3', NULL, NULL, 90, 0, 90, 1),
(24, 'CD20', 'axelcoreos@gmail.com', NULL, '2023-11-27 17:51:50', NULL, NULL, 'mamaconeja', NULL, 'PIK', 'Dirección de usuario 88', NULL, NULL, NULL, 0, NULL, 'transferenciaBancaria', NULL, NULL, NULL, NULL, 'EP-1', NULL, NULL, 180, 0, 180, 0),
(25, 'CD21', 'yola_chan@hotmail.com', NULL, '2023-11-27 19:40:35', NULL, NULL, 'mamaconeja', NULL, 'PIK', 'Dirección de usuario 88', '2023-12-09 00:00:00', 'CD21', 'Tu producto será entregado en la entrada del Huerto, el día que nos acompañes al CONEJON. Gracias por tu preferencia.', 0, '2023-11-28 13:22:18', 'spinOxxo', 'comprobantePago.jpg', NULL, NULL, NULL, 'EP-3', NULL, NULL, 90, 0, 90, 1),
(26, 'CD22', 'ringog93@gmail.com', NULL, '2023-11-30 14:14:08', NULL, NULL, 'mamaconeja', NULL, 'PIK', 'Dirección de usuario 88', '2023-12-09 00:00:00', 'CD22', 'Tu producto será entregado en la entrada del Huerto, el día que nos acompañes al CONEJON. Gracias por tu preferencia.', 0, '2023-11-30 14:16:01', 'transferenciaBancaria', 'comprobantePago.jpg', NULL, NULL, NULL, 'EP-3', NULL, NULL, 180, 0, 180, 1),
(27, 'CD23', 'fmartinez.andrade0@gmail.com', NULL, '2023-11-30 14:41:55', NULL, NULL, 'mamaconeja', NULL, 'PIK', 'Dirección de usuario 88', '2023-12-09 00:00:00', 'CD23', 'Tu producto será entregado en la entrada del Huerto, el día que nos acompañes al CONEJON. Gracias por tu preferencia.', 0, '2023-11-30 14:48:43', 'transferenciaBancaria', 'comprobantePago.pdf', NULL, NULL, NULL, 'EP-3', NULL, NULL, 90, 0, 90, 1),
(28, 'CD24', 'montserrat.ortega.r@gmail.com', NULL, '2023-11-30 16:17:16', NULL, NULL, 'mamaconeja', NULL, 'PIK', 'Dirección de usuario 88', NULL, NULL, NULL, 0, NULL, 'transferenciaBancaria', NULL, NULL, NULL, NULL, 'EP-1', NULL, NULL, 90, 0, 90, 1),
(29, 'CD25', 'andrea.taylor.munguia@gmail.com', NULL, '2023-11-30 21:06:22', NULL, NULL, 'mamaconeja', NULL, 'PIK', 'Dirección de usuario 88', '2023-12-09 00:00:00', 'CD25', 'Tu producto será entregado en la entrada del Huerto, el día que nos acompañes al CONEJON. Gracias por tu preferencia.', 0, '2023-11-30 21:09:57', 'transferenciaBancaria', 'comprobantePago.png', NULL, NULL, NULL, 'EP-3', NULL, NULL, 90, 0, 90, 1),
(30, 'CD26', 'gcrgaby584@gmail.com', NULL, '2023-12-01 15:21:25', NULL, NULL, 'mamaconeja', NULL, 'PIK', 'Dirección de usuario 88', NULL, NULL, NULL, 0, NULL, 'spinOxxo', NULL, NULL, NULL, NULL, 'EP-1', NULL, NULL, 90, 0, 90, 1),
(31, 'CD27', 'quetzal2405@hotmail.com', NULL, '2023-12-01 22:01:02', NULL, NULL, 'mamaconeja', NULL, 'PIK', 'Dirección de usuario 88', NULL, NULL, NULL, 0, NULL, 'spinOxxo', NULL, NULL, NULL, NULL, 'EP-1', NULL, NULL, 90, 0, 90, 1),
(32, 'CD28', 'lutthmila@gmail.com', NULL, '2023-12-02 11:15:41', NULL, NULL, 'mamaconeja', NULL, 'PIK', 'Dirección de usuario 88', '2023-12-09 00:00:00', 'CD28', 'Tu producto será entregado en la entrada del Huerto, el día que nos acompañes al CONEJON. Gracias por tu preferencia.', 0, '2023-12-02 12:21:47', 'transferenciaBancaria', 'comprobantePago.png', NULL, NULL, NULL, 'EP-3', NULL, NULL, 90, 0, 90, 1),
(33, 'CD29', 'bluemayu1407@gmail.com', NULL, '2023-12-02 21:56:27', NULL, NULL, 'mamaconeja', NULL, 'PIK', 'Dirección de usuario 88', NULL, NULL, NULL, 0, NULL, 'transferenciaBancaria', NULL, NULL, NULL, NULL, 'EP-1', NULL, NULL, 90, 0, 90, 1),
(34, 'CD30', 'bluemayu1407@gmail.com', NULL, '2023-12-02 22:01:06', NULL, NULL, 'mamaconeja', NULL, 'PIK', 'Dirección de usuario 88', NULL, NULL, NULL, 0, NULL, 'transferenciaBancaria', NULL, NULL, NULL, NULL, 'EP-1', NULL, NULL, 90, 0, 90, 1),
(35, 'CD31', 'bluemayu1407@gmail.com', NULL, '2023-12-02 22:02:44', NULL, NULL, 'mamaconeja', NULL, 'PIK', 'Dirección de usuario 88', '2023-12-09 00:00:00', 'CD31', 'Tu producto será entregado en la entrada del Huerto, el día que nos acompañes al CONEJON. Gracias por tu preferencia.', 0, '2023-12-02 22:12:47', 'transferenciaBancaria', 'comprobantePago.jpg', NULL, NULL, NULL, 'EP-3', NULL, NULL, 180, 0, 180, 1),
(36, 'CD32', 'julio_cdc@outlook.com', NULL, '2023-12-03 17:06:53', NULL, NULL, 'mamaconeja', NULL, 'PIK', 'Dirección de usuario 88', '2023-12-09 00:00:00', 'CD32', 'Tu producto será entregado en la entrada del Huerto, el día que nos acompañes al CONEJON. Gracias por tu preferencia.', 0, '2023-12-03 19:56:29', 'transferenciaBancaria', 'comprobantePago.jpeg', NULL, NULL, NULL, 'EP-3', NULL, NULL, 90, 0, 90, 1);
...
INSERT INTO `productos` (`id`, `idProducto`, `barcode`, `idTienda`, `idCategoria`, `nombre`, `descripcion`, `costo`, `precio`, `precioOferta`, `unidadVenta`, `inventario`, `inventarioMinimo`, `requiereEnvio`, `isActiveOnlineStore`, `isActive`) VALUES
(1, 'P-1', '8828000000001', 'picoslocos', 'Eaa089fa5defa0031a3991ab17dc', 'Heno De Avena (3 Kg)', 'heno de avena 3 kilos por $150 \r\nheno cultivado especialmente para mascotas de compa&ntilde;&iacute;a, podr&aacute;s adquirir heno limpio, fresco y muy crocante.\r\nideal para todas las edades, ayuda a mantener una digesti&oacute;n adecuada y al desgaste dental.', 150, 150, 0, 'Piezas', 20, 5, 1, 1, 1),
(2, 'P-2', '8828000000002', 'picoslocos', 'Eaa089fa5defa0031a3991ab17dc', 'Heno De Trigo (1 Kg)', 'bolsa con 1 kilo de heno por $60\r\n el trigo cosechado para su uso exclusivo como heno recibir&aacute;s heno verde alto en fibra, con bajo contenido en prote&iacute;nas y calcio.\r\nideal para todas las edades', 60, 60, 0, 'Piezas', 15, 5, 1, 1, 1),
(3, 'P-3', '8828000000001', 'conejondigital', 'E571547d30811d95aec0e69990fb', 'Asd', 'asda', 10, 50, 0, 'Piezas', 5, 3, 1, 1, 1),
(4, 'P-4', '8828000000003', 'picoslocos', 'Ae6434d035fa629d9dac31ecf5fa', 'Henera Colgante', 'este modelo de henera es ideal para colgar en la pared o recinto de tu orejon, adem&aacute;s te ayudar&aacute; a evitar desperdicios de heno, al ser de madera natural puede ser mordisqueable por tu orejon y no le es da&ntilde;ino.', 270, 270, 0, 'Piezas', 15, 5, 1, 1, 1),
(5, 'P-5', '8828000000004', 'picoslocos', 'Ae6434d035fa629d9dac31ecf5fa', 'Henera Torre', 'la henera torre te va a facilitar alimentar a tu orejon ya que es un modelo dos en uno donde podr&aacute;s colocar pellets y heno. \r\nes de madera natural.', 250, 250, 0, 'Piezas', 10, 4, 1, 1, 1),
(6, 'P-6', '8828000000005', 'picoslocos', 'Ae6434d035fa629d9dac31ecf5fa', 'Henera Rodante', 'bello modelo de henera que adem&aacute;s de poder usarlo para evitar desperdicio puede funcionar como un juguete para enriquecer su ambiente.', 145, 145, 0, 'Piezas', 12, 4, 1, 1, 1),
(7, 'P-7', '8828000000006', 'picoslocos', 'Ae6434d035fa629d9dac31ecf5fa', 'Mini Henera Rodante', 'una opci&oacute;n para administrar heno de forma divertida, ayudar&aacute; a enriquecer su ambiente.', 95, 95, 0, 'Piezas', 12, 4, 1, 1, 1),
(8, 'P-8', '8828000000007', 'picoslocos', 'Ae6434d035fa629d9dac31ecf5fa', 'Henera Torre Mini', 'henera dos en uno te permite dar heno y pellets. su tama&ntilde;o es ideal para conejos enanos o beb&eacute;s.', 149, 149, 0, 'Piezas', 20, 6, 1, 1, 1),
(9, 'P-9', '8828000000008', 'picoslocos', 'Ae6434d035fa629d9dac31ecf5fa', 'BasHenera', 'henera ideal para que tu orejon tenga heno disponible por m&aacute;s de 24 horas, gracias a tu tama&ntilde;o es ideal para varios orejones.\r\nelaborado con madera natural.\r\n\r\ncont&aacute;ctanos 5582280606\r\nrecuerda que tenemos env&iacute;os a toda la rep&uacute;blica mexicana.', 269, 269, 0, 'Piezas', 15, 5, 1, 1, 1),
(10, 'P-10', '8828000000009', 'picoslocos', 'D92e6b3a10748fc3861bdba5af65', 'EsquiHenera', 'este incre&iacute;ble modelo te permite tener todo en un mismo lugar, henera, bebedero y esquinero para que tu orejon haga del ba&ntilde;o ah&iacute;, gracias a nuestro incre&iacute;ble dise&ntilde;o no necesita sustrato y las patitas no quedan en contacto con la pipi, bastar&aacute; lavar tu esquin', 550, 550, 0, 'Piezas', 10, 3, 1, 1, 1),
(11, 'P-11', '8828000000010', 'picoslocos', '5cf93825dad202feacfae159121d', 'Comedero Y Bebedero Automatico', 'estos comederos no usan pilas ni electricidad, sirven por gravedad. son ideales para dejarles agua y alimento suficiente a nuestros orejones por si en alg&uacute;n momento debemos ausentarnos varias horas. \r\n\r\ncomedero $250\r\nbebedero $250 \r\n\r\nleva ambos por solo $420', 250, 250, 0, 'Piezas', 20, 5, 1, 1, 1),
(12, 'P-12', '8828000000011', 'picoslocos', '5cf93825dad202feacfae159121d', 'Plato Colgante', 'ideal para colocar en los recintos de nuestros orejones, te brindar&aacute; estabilidad y evitar&aacute; que tiren su agua o alimento.\r\n\r\ncapacidad 1 litro. $90\r\ncapacidad 600ml $65', 65, 65, 0, 'Piezas', 30, 10, 1, 1, 1);
...
(129, 'kardon_555@hotmail.com', 'CN2023', '2023-11-21 18:59:24', NULL, 0, NULL),
(130, 'jessly2018@yahoo.com', 'CN2023', '2023-11-21 23:54:17', NULL, 0, NULL),
(131, 'kkatyvane@gmail.com', 'CN2023', '2023-11-22 02:12:40', NULL, 0, NULL),
(132, 'valeriathaliaperezestevez@gmail.com', 'CN2023', '2023-11-22 05:22:18', NULL, 0, NULL),
(133, 'ednaalbamorales@gmail.com', 'CN2023', '2023-11-22 08:41:25', NULL, 0, NULL),
(134, 'martinezrosalessamantha@gmail.com', 'CN2023', '2023-11-22 09:52:45', NULL, 0, NULL),
(135, 'segurosjst@gmail.com', 'CN2023', '2023-11-22 17:40:36', NULL, 0, NULL),
(136, 'sandillescas26@gmail.com', 'CN2023', '2023-11-22 18:35:49', NULL, 0, NULL),
(137, 'isa_als19@hotmail.com', 'CN2023', '2023-11-22 22:20:27', NULL, 0, NULL),
(138, 'thebunnykingdommx@gmail.com', 'CN2023', '2023-11-23 07:29:51', NULL, 0, NULL),
(139, 'jazvega.psico@gmail.com', 'CN2023', '2023-11-23 18:11:48', NULL, 0, NULL),
(140, 'dyiana_mathdoors@hotmail.com', 'CN2023', '2023-11-23 18:13:56', NULL, 0, NULL),
(141, 'usagiari12@gmail.com', 'CN2023', '2023-11-23 18:32:58', NULL, 0, NULL),
(142, 'senekismarin@gmail.com', 'CN2023', '2023-11-23 18:36:38', NULL, 0, NULL),
(143, 'diaragones@icloud.com', 'CN2023', '2023-11-23 19:17:14', NULL, 0, NULL),
(144, 'jazmin.eacj@gmail.com', 'CN2023', '2023-11-23 20:54:42', NULL, 0, NULL),
(145, 'minsung.13.mv6@gmail.com', 'CN2023', '2023-11-23 21:58:54', NULL, 0, NULL),
(146, 'zunigadriana1106@gmail.com', 'CN2023', '2023-11-23 23:21:36', NULL, 0, NULL),
(147, 'dianucha99@gmail.com', 'CN2023', '2023-11-23 23:34:29', NULL, 0, NULL),
(148, 'carrilloanalilia0@gmail.com', 'CN2023', '2023-11-24 09:08:55', NULL, 0, NULL),
(149, 'fugtr20@hotmail.com', 'CN2023', '2023-11-24 11:25:14', NULL, 0, NULL),
(150, 'fridass5@outlook.com', 'CN2023', '2023-11-24 17:28:20', NULL, 0, NULL),
(151, 'e_stay_09@naver.com', 'CN2023', '2023-11-24 19:59:16', NULL, 0, NULL),
(152, 'Lina91185@hotmail.com', 'CN2023', '2023-11-25 02:15:44', NULL, 0, NULL),
(153, 'cortesjimenezm65@gmail.com', 'CN2023', '2023-11-26 10:26:30', NULL, 0, NULL),
(154, 'adriana8898@gmail.com', 'CN2023', '2023-11-26 10:41:35', NULL, 0, NULL),
(155, 'irving878@gmail.com', 'CN2023', '2023-11-26 20:35:33', NULL, 0, NULL),
(156, 'jessyflo7@gmail.com', 'CN2023', '2023-11-26 20:38:15', NULL, 0, NULL),
(157, 'saltodelconejo@gmail.com', 'CN2023', '2023-11-27 14:45:40', NULL, 0, NULL),
(158, 'cecyblanju29@gmail.com', 'CN2023', '2023-11-27 15:22:53', NULL, 0, NULL),
(159, 'seltran@hotmail.com', 'CN2023', '2023-11-27 15:38:49', NULL, 0, NULL),
(160, 'yola_chan@hotmail.com', 'CN2023', '2023-11-27 19:26:08', NULL, 0, NULL),
(161, 'gustavo.mtz.df@gmail.com', 'CN2023', '2023-11-27 23:49:01', NULL, 0, NULL),
(162, 'jessie_hoa@hotmail.com', 'CN2023', '2023-11-28 21:00:13', NULL, 0, NULL),
(163, 'jackie_jmj@live.com', 'CN2023', '2023-11-28 21:57:06', NULL, 0, NULL),
(164, 'aliferta31@gmail.com', 'CN2023', '2023-11-29 07:46:05', NULL, 0, NULL),
(165, 'fmartinez.andrade0@gmail.com', 'CN2023', '2023-11-30 14:32:16', NULL, 0, NULL),
(166, 'luna.gonzalez.ofe@gmail.com', 'CN2023', '2023-11-30 15:02:36', NULL, 0, NULL),
(167, 'montserrat.ortega.r@gmail.com', 'CN2023', '2023-11-30 16:12:28', NULL, 0, NULL),
(168, 'manuel131297@gmail.com', 'CN2023', '2023-11-30 18:27:23', NULL, 0, NULL),
(169, 'robert_82_26@hotmail.com', 'CN2023', '2023-11-30 19:59:46', NULL, 0, NULL),
(170, 'andrea.taylor.munguia@gmail.com', 'CN2023', '2023-11-30 20:52:11', NULL, 0, NULL),
(171, 'eclipse_ec17@hotmail.com', 'CN2023', '2023-11-30 23:01:10', NULL, 0, NULL),
(172, 'peque201214@gmail.com', 'CN2023', '2023-11-30 23:47:33', NULL, 0, NULL),
(173, 'asda.p9.fm@outlook.com', 'CN2023', '2023-12-01 11:15:08', NULL, 0, NULL),
(174, 'gcrgaby584@gmail.com', 'CN2023', '2023-12-01 15:18:25', NULL, 0, NULL),
(175, 'sampallo1976@gmail.com', 'CN2023', '2023-12-01 15:55:24', NULL, 0, NULL),
(176, 'avalosr44@hotmail.com', 'CN2023', '2023-12-01 16:32:06', NULL, 0, NULL),
(177, 'karina.mtzsandoval@gmail.com', 'CN2023', '2023-12-01 16:55:13', NULL, 0, NULL),
(178, 'kmejia.sanchez92@gmail.com', 'CN2023', '2023-12-01 17:13:45', NULL, 0, NULL),
(179, 'rodmequit1104@gmail.com', 'CN2023', '2023-12-01 18:21:30', NULL, 0, NULL),
(180, 'imaryfer@yahoo.com.mx', 'CN2023', '2023-12-01 19:06:17', NULL, 0, NULL),
(181, 'avilabelloviridiana@gmail.com', 'CN2023', '2023-12-01 19:29:06', NULL, 0, NULL),
(182, 'pollo_fercho@hotmail.com', 'CN2023', '2023-12-01 19:39:12', NULL, 0, NULL),
(183, 'big_dan@live.com.mx', 'CN2023', '2023-12-01 19:53:24', NULL, 0, NULL),
(184, 'yocelyn.olvera@hotmail.com', 'CN2023', '2023-12-01 20:02:09', NULL, 0, NULL),
(185, 'zeta_ciber9@hotmail.com', 'CN2023', '2023-12-01 20:58:48', NULL, 0, NULL),
(186, 'andrianoirma@gmail.com', 'CN2023', '2023-12-01 22:11:40', NULL, 0, NULL),
(187, 'garfu00@gmail.com', 'CN2023', '2023-12-01 23:08:21', NULL, 0, NULL),
(188, 'eame1994@gmail.com', 'CN2023', '2023-12-02 00:12:33', NULL, 0, NULL),
(189, 'itzel0503_05@hotmail.com', 'CN2023', '2023-12-02 00:28:26', NULL, 0, NULL),
(190, 'fabiolasalas1986@gmail.com', 'CN2023', '2023-12-02 02:49:35', NULL, 0, NULL),
(191, 'nadykawaii2011@gmail.com', 'CN2023', '2023-12-02 10:03:02', NULL, 0, NULL),
(192, 'lanenachiquita@hotmail.com', 'CN2023', '2023-12-02 10:10:45', NULL, 0, NULL),
(193, 'teboyfaby@hotmail.com', 'CN2023', '2023-12-02 10:12:19', NULL, 0, NULL),
(194, 'moradozh2468@gmail.com', 'CN2023', '2023-12-02 10:49:38', NULL, 0, NULL),
(195, 'lutthmila@gmail.com', 'CN2023', '2023-12-02 10:52:23', NULL, 0, NULL),
(196, 'saactaledith420@gmail.com', 'CN2023', '2023-12-02 12:18:46', NULL, 0, NULL),
(197, 'smith020100@gmail.com', 'CN2023', '2023-12-02 13:49:15', NULL, 0, NULL),
(198, 'jeskarlos@hotmail.com', 'CN2023', '2023-12-02 14:03:34', NULL, 0, NULL),
(199, 'Fr7593100@gmail.com', 'CN2023', '2023-12-02 17:17:05', NULL, 0, NULL),
(200, 'mark2012uwu@gmail.com', 'CN2023', '2023-12-02 19:53:21', NULL, 0, NULL),
(201, 'derek_patlani@outlook.com', 'CN2023', '2023-12-02 19:55:09', NULL, 0, NULL),
(202, 'lizgrife@gmail.com', 'CN2023', '2023-12-02 20:05:06', NULL, 0, NULL),
(203, 'marianamdiazh97@gmail.com', 'CN2023', '2023-12-02 20:05:15', NULL, 0, NULL),
(204, 'bluemayu1407@gmail.com', 'CN2023', '2023-12-02 21:46:49', NULL, 0, NULL),
(205, 'christian.cornejo@outlook.com', 'CN2023', '2023-12-02 21:54:25', NULL, 0, NULL),
(206, 'raymundo.casas.c@gmail.com', 'CN2023', '2023-12-02 21:59:41', NULL, 0, NULL),
(207, 'bemb2802@gmail.com', 'CN2023', '2023-12-02 22:03:01', NULL, 0, NULL),
(208, 'humberto_198132@hotmail.com', 'CN2023', '2023-12-02 22:12:05', NULL, 0, NULL),
(209, 'fernandaalvarez164kz@gmail.com', 'CN2023', '2023-12-02 22:49:12', NULL, 0, NULL),
(210, 'evangelion_apocrifo@hotmail.com', 'CN2023', '2023-12-02 23:05:39', NULL, 0, NULL),
(211, 'notemetasconwoojin@gmail.com', 'CN2023', '2023-12-02 23:36:52', NULL, 0, NULL),
(212, 'analilia.ruiz20@gmail.com', 'CN2023', '2023-12-02 23:52:38', NULL, 0, NULL),
(213, 'abi.ago08@gmail.com', 'CN2023', '2023-12-03 08:08:35', NULL, 0, NULL),
(214, 'limaroma1966@gmail.com', 'CN2023', '2023-12-03 09:29:43', NULL, 0, NULL),
(215, 'estefanymonserrat015@gmail.com', 'CN2023', '2023-12-03 11:58:52', NULL, 0, NULL),
(216, 'nadiiasoto06@gmail.com', 'CN2023', '2023-12-03 15:30:38', NULL, 0, NULL),
(217, 'julio_cdc@outlook.com', 'CN2023', '2023-12-03 17:00:53', NULL, 0, NULL),
(218, 'ladequesosinsalsa@gmail.com', 'CN2023', '2023-12-03 17:02:21', NULL, 0, NULL),
(219, 'hellarad24@hotmail.com', 'CN2023', '2023-12-03 17:35:59', NULL, 0, NULL),
(220, 'paulinushca@hotmail.com', 'CN2023', '2023-12-03 19:25:07', NULL, 0, NULL),
(221, 'tanylizeth006@gmail.com', 'CN2023', '2023-12-03 22:02:29', NULL, 0, NULL),
(222, 'fernandocamacholeyva@hotmail.com', 'CN2023', '2023-12-03 22:30:14', NULL, 0, NULL),
(223, 'djn0622o@dee.edu.mx', 'CN2023', '2023-12-04 07:34:48', NULL, 0, NULL),
(224, 'herediaobed.derecho@gmail.com', 'CN2023', '2023-12-04 08:41:16', NULL, 0, NULL),
(225, 'pimpi1705@gmail.com', 'CN2023', '2023-12-04 09:42:10', NULL, 0, NULL),
(226, 'emmanuelpulido2001@gmail.com', 'CN2023', '2023-12-04 10:07:06', NULL, 0, NULL),
(227, 'mariibalmar@gmail.com', 'CN2023', '2023-12-04 19:16:02', NULL, 0, NULL),
(228, 'balderasmari231199@gmail.com', 'CN2023', '2023-12-04 19:18:11', NULL, 0, NULL),
(229, 'maria.fernanda.omemartinez@bggem.mx', 'CN2023', '2023-12-04 19:21:12', NULL, 0, NULL),
(230, 'jsr1_gaviota@hotmail.com', 'CN2023', '2023-12-04 19:46:25', NULL, 0, NULL),
(231, 'gm5549141@gmail.com', 'CN2023', '2023-12-04 22:45:11', NULL, 0, NULL),
(232, 'danieru0108937@gmail.com', 'CN2023', '2023-12-05 08:30:46', NULL, 0, NULL),
(233, 'cinthianavarro353@gmail.com', 'CN2023', '2023-12-05 10:37:28', NULL, 0, NULL),
(234, 'pausriv@gmail.com', 'CN2023', '2023-12-05 11:04:49', NULL, 0, NULL),
(235, 'analuci.medina08@gmail.com', 'CN2023', '2023-12-05 13:45:31', NULL, 0, NULL),
(236, 'gothrichie@hotmail.com', 'CN2023', '2023-12-05 15:15:57', NULL, 0, NULL),
(237, 'michellmarilyn777@gmail.com', 'CN2023', '2023-12-05 17:27:31', NULL, 0, NULL),
(238, 'massielmejia99@gmail.com', 'CN2023', '2023-12-05 17:47:43', NULL, 0, NULL),
(239, 'ursulaconeja@gmail.com', 'CN2023', '2023-12-05 18:59:46', NULL, 0, NULL),
(240, 'lilimondra0212@gmail.com', 'CN2023', '2023-12-05 19:50:55', NULL, 0, NULL),
(241, 'diegosandovalgr282@gmail.com', 'CN2023', '2023-12-05 20:12:34', NULL, 0, NULL),
(242, 'abaun.sa@gmail.com', 'CN2023', '2023-12-05 20:16:48', NULL, 0, NULL),
(243, 'maximilianoromansanchez3@gmail.com', 'CN2023', '2023-12-05 20:19:23', NULL, 0, NULL),
(244, 'olgapzuniga@gmail.com', 'CN2023', '2023-12-05 20:57:50', NULL, 0, NULL);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `reputacionTienda`
--

CREATE TABLE `reputacionTienda` (
  `id` int(11) NOT NULL,
  `idPedido` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `idTienda` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `idCliente` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
--
-- Estructura de tabla para la tabla `sucursalesTienda`
--

CREATE TABLE `sucursalesTienda` (
  `id` int(11) NOT NULL,
  `idTienda` varchar(200) CHARACTER SET utf8 COLLATE utf8_spanish_ci NOT NULL,
  `idSucursal` varchar(255) CHARACTER SET utf8 COLLATE utf8_spanish_ci NOT NULL,
  `nombreSucursal` varchar(200) CHARACTER SET utf8 COLLATE utf8_spanish_ci NOT NULL,
  `codigoPostal` varchar(8) CHARACTER SET utf8 COLLATE utf8_spanish_ci NOT NULL,
  `estado` varchar(200) CHARACTER SET utf8 COLLATE utf8_spanish_ci NOT NULL,
  `municipioAlcaldia` varchar(200) CHARACTER SET utf8 COLLATE utf8_spanish_ci NOT NULL,
  `colonia` varchar(200) CHARACTER SET utf8 COLLATE utf8_spanish_ci NOT NULL,
  `calle` varchar(200) CHARACTER SET utf8 COLLATE utf8_spanish_ci NOT NULL,
  `numeroExterior` varchar(100) CHARACTER SET utf8 COLLATE utf8_spanish_ci NOT NULL,
  `interiorDepto` varchar(100) CHARACTER SET utf8 COLLATE utf8_spanish_ci DEFAULT NULL,
  `entreCalle1` varchar(200) CHARACTER SET utf8 COLLATE utf8_spanish_ci DEFAULT NULL,
  `entreCalle2` varchar(200) CHARACTER SET utf8 COLLATE utf8_spanish_ci DEFAULT NULL,
  `telefono` varchar(100) CHARACTER SET utf8 COLLATE utf8_spanish_ci NOT NULL,
  `indicacionesAdicionales` varchar(228) CHARACTER SET utf8 COLLATE utf8_spanish_ci DEFAULT NULL,
  `isPrincipal` tinyint(1) NOT NULL,
  `isPickUpAvailable` tinyint(4) NOT NULL DEFAULT 1,
  `isActive` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;

--
-- Volcado de datos para la tabla `sucursalesTienda`
--

INSERT INTO `sucursalesTienda` (`id`, `idTienda`, `idSucursal`, `nombreSucursal`, `codigoPostal`, `estado`, `municipioAlcaldia`, `colonia`, `calle`, `numeroExterior`, `interiorDepto`, `entreCalle1`, `entreCalle2`, `telefono`, `indicacionesAdicionales`, `isPrincipal`, `isPickUpAvailable`, `isActive`) VALUES
(1, 'mamaconeja', 'SUC-2', 'Conej&oacute;n Navide&ntilde;o 2023', '55100', 'CIUDAD DE MEXICO', 'Tlahuac', 'NA', 'NA', 'NA', 'NA', '', '', '5584301111', '', 1, 1, 1),
(2, 'picoslocos', 'SUC-3', 'Picos Locos', '55330', 'ESTADO DE MEXICO', 'Ecatepec', 'San Francisco xal', 'Cda san pablo', 'B-16', '', 'Jorge Giménez Cantú ', 'Calle san pablo', '5582280606', 'Si gustas envíanos whatsapp y te compartimos la ubicación exacta 5582280606', 1, 1, 1);
...
(57, 'axelcoreos@gmail.com', 'CD20', '65580a5e3cde1_00780432075008l.webp', '5.jpg', 1),
...
(68, 'valeriathaliaperezestevez@gmail.com', NULL, '655e2e0e5aa2d_inbound8202854989549690849.jpg', '2.jpg', 0),
(69, 'abigailromeroh@gmail.com', 'CD14', '655fee1252005_IMG_5679.jpeg', '4.jpg', 1),
(70, 'senekismarin@gmail.com', NULL, '655ff28d723c9_inbound940596453017842318.jpg', '5.jpg', 0),
(72, 'jazmin.eacj@gmail.com', 'CD15', '656010f060bae_IMG_20231113_200510.jpg', '3.jpg', 1),
(73, 'dianucha99@gmail.com', 'CD16', '6560367f321ff_AF29E2BEB9C349AB8159D5CC449AA21E.jpeg', '5.jpg', 1),
(74, 'fridass5@outlook.com', NULL, '65613590f4047_0BF12EAB9C2D4DF4BF448D5C5AD65512.jpeg', '3.jpg', 0),
(76, 'lolite.s.m@hotmail.com', 'CD17', '6562174b386f8_20231117_102558_0000_edit_408483038950116.png', '6.jpg', 1),
(79, 'cortesjimenezm65@gmail.com', 'CD18', '6563730c93b0f_inbound1104830431571694294.jpg', '5.jpg', 1),
(80, 'sparklylollipop05@gmail.com', 'CD19', '6564b6f944c82_IMG_20190225_223914601.jpg', '3.jpg', 1),
(81, 'axelcoreos@gmail.com', 'CD20', '65652b8a50f56_403625742_743759754442322_4055234246171698636_n.jpg', '4.jpg', 1),
(83, 'yola_chan@hotmail.com', 'CD21', '656544e41dcfc_Fotodeyola_ramm.jpg', '2.jpg', 1),
(84, 'seltran@hotmail.com', NULL, '65675e7c00693_20231.jpg', '2.jpg', 0),
(85, 'ringog93@gmail.com', 'CD22', '6568ebef51c75_20231117_184504.jpg', '2.jpg', 1),
(86, 'ringog93@gmail.com', 'CD22', '6568ecfe42541_20231117_184534.jpg', '3.jpg', 1),
(87, 'fmartinez.andrade0@gmail.com', 'CD23', '6568f3613d54d_Haru.jpg', '2.jpg', 1),
(88, 'montserrat.ortega.r@gmail.com', 'CD24', '656909d356631_20231022_143337.jpg', '2.jpg', 1),
(91, 'andrea.taylor.munguia@gmail.com', 'CD25', '65694d8516cf1_inbound5425118140266021217.jpg', '1.jpg', 1),
(92, 'gcrgaby584@gmail.com', 'CD26', '656a4dcf7d959_inbound6955986718778370626.jpg', '4.jpg', 1),
(93, 'quetzal2405@hotmail.com', 'CD27', '656aabcd2147b_retouch_1701440380270.JPEG', '1.jpg', 1),
(95, 'lutthmila@gmail.com', 'CD28', '656b65e0e74e6_inbound6016610661317740946.png', '2.jpg', 1),
(96, 'lizgrife@gmail.com', NULL, '656be306b36a5_20230604_173633.jpg', '3.jpg', 0),
(98, 'bluemayu1407@gmail.com', 'CD29', '656bfc25bb6a4_IMG20231021WA0016.jpg', '3.jpg', 1),
(99, 'christian.cornejo@outlook.com', NULL, '656bfd2daf534_inbound4314802929811205138.jpg', '1.jpg', 0),
(100, 'bluemayu1407@gmail.com', 'CD30', '656bfd7686fe0_20231126_164442.jpg', '6.jpg', 1),
(101, 'bluemayu1407@gmail.com', 'CD31', '656bfdafeb6e5_20231126_164227.jpg', '5.jpg', 1),
(102, 'bluemayu1407@gmail.com', 'CD31', '656bfdd58d76e_20231126_164442.jpg', '6.jpg', 1),
(103, 'Sabatt.black@gmail.com', NULL, '656c0d393a1d5_E6626BE7BF274E109AEED7D7887E2922.jpeg', '2.jpg', 0),
(104, 'abi.ago08@gmail.com', NULL, '656c8c6eb6107_A2538E54BA2F40E888933057BF713403.jpeg', '5.jpg', 0),
(105, 'limaroma1966@gmail.com', NULL, '656c9f63027b2_IMG_2165.jpeg', '3.jpg', 0),
(106, 'julio_cdc@outlook.com', 'CD32', '656d09cbd719a_a60c9f463d1a4747b8c32cd9512bec96.jpeg', '3.jpg', 1),
(107, 'tanylizeth006@gmail.com', NULL, '656d4fd7423fe_A48C1FD9DBC24D308DFAA2EF30D3C525.jpeg', '4.jpg', 0),
(108, 'fernandocamacholeyva@hotmail.com', NULL, '656d565e2e124_inbound881917090836448928.jpg', '4.jpg', 0);
...
(1, 'conejondigital', 'Conejón Digital', 'axelcoreos@gmail.com', 1),
(2, 'mamaconeja', 'Mamá Coneja', 'axelcoreos@gmail.com', 1),
(3, 'mamaconeja', 'Mamá Coneja', 'gabriela.rios.h@hotmail.com', 1),
(4, 'picoslocos', 'Picos Locos', 'dash230216@gmail.com', 1);
...
(5, 'Alfredo Espinoza', NULL, NULL, NULL, 'aespinozabgx@gmail.com', NULL, '2023-08-21 06:42:30', '9935', NULL, NULL, 0, 0, 0),
...
(16, 'Axel Espinoza', NULL, NULL, NULL, 'axelcoreos@gmail.com', '123', '2023-10-02 20:32:21', '4469', 'su', '2023-10-02 20:33:06', 1, 0, 1),
...
(30, 'Fernanda Rodríguez ', NULL, NULL, NULL, 'rodmequit1104@gmail.com', 'maicol123', '2023-10-10 10:30:11', '0800', '', '2023-10-10 10:31:23', 1, 0, 0),
...
(43, 'Jorge Daniel Gutierrez Avilés ', NULL, NULL, NULL, 'big_dan@live.com.mx', '198612', '2023-10-10 10:44:15', '8949', '', '2023-10-10 14:41:59', 1, 0, 0),
...
(46, 'JAZMIN VEGA', NULL, NULL, NULL, 'jazvega.psico@gmail.com', 'JAZM1N44...', '2023-10-10 10:50:35', 'NULL', '', '2023-11-23 18:11:48', 1, 0, 0),
...
(79, 'Fabiola Sánchez ', NULL, NULL, NULL, 'ursulaconeja@gmail.com', 'ivonne', '2023-10-10 11:57:24', '8425', '', '2023-10-10 13:34:12', 1, 0, 0),
...
(147, 'Maria Fernanda Mendoza ', NULL, NULL, NULL, 'imaryfer@yahoo.com.mx', '1991', '2023-10-10 16:14:16', '5471', '', '2023-10-10 16:14:48', 1, 0, 0),
...
(203, 'Monserrat Gea ', NULL, NULL, NULL, 'eclipse_ec17@hotmail.com', '110194', '2023-10-10 21:38:51', '6157', '', '2023-10-10 21:40:17', 1, 0, 0),
...
(220, 'Tatiana Ortega Ramirez', NULL, NULL, NULL, 'montserrat.ortega.r@gmail.com', 'M9ntserrat36', '2023-10-11 10:19:07', '3427', '', '2023-10-11 10:19:45', 1, 0, 0),
...
(259, 'Orejitas carambola ', NULL, NULL, NULL, 'gabymz9627@gmail.com', '129607', '2023-10-17 13:36:45', '8799', NULL, '2023-10-17 13:37:55', 1, 0, 0),
(260, 'Fatima Ysusi', NULL, NULL, NULL, 'faysusi@hotmail.com', '3gordoa', '2023-10-17 21:59:43', 'NULL', NULL, '2023-10-17 22:00:44', 1, 0, 0),
(261, 'Iride Campos ', NULL, NULL, NULL, 'irideca16@gmail.com', '161002', '2023-10-18 08:52:50', '7656', NULL, '2023-10-18 08:53:34', 1, 0, 0),
...
(280, 'Johanes Moisés García Limón ', NULL, NULL, NULL, 'johanesgarcia@hotmail.com', NULL, '2023-10-20 22:54:45', '3045', NULL, NULL, 0, 0, 0),
...
(316, 'Gabriela Cornejo Reyes ', NULL, NULL, NULL, 'gcrgaby584@gmail.com', 'conreyoss', '2023-10-27 06:19:25', '8477', NULL, '2023-10-27 06:20:01', 1, 0, 0),
...
(329, 'Jazmin Del Carmen ', NULL, NULL, NULL, 'kitty25jazmin@gmail.com', 'KillerMa54', '2023-10-29 11:30:12', '1878', NULL, '2023-10-29 11:32:15', 1, 0, 0),
...
(367, 'Susana Osorio Serrano ', NULL, NULL, NULL, 'dash230216@gmail.com', 'picoslocos', '2023-11-07 10:28:21', 'NULL', NULL, '2023-11-07 10:29:49', 1, 0, 1),
...
(378, 'Élise', NULL, NULL, NULL, 'hellarad24@hotmail.com', 'CRAYOLA24', '2023-11-08 02:24:49', 'NULL', NULL, '2023-12-03 17:35:59', 1, 0, 0),
(379, 'Maria Fernanda Romero Martinez', NULL, NULL, NULL, 'mari_balderas23@outlook.com', '231199', '2023-11-08 06:50:56', '4569', NULL, '2023-11-08 06:54:51', 1, 0, 0),
...
(413, 'Roxana', NULL, NULL, NULL, 'quetzal2405@hotmail.com', '011175', '2023-11-15 18:32:47', '8257', NULL, '2023-11-15 18:33:44', 1, 0, 0),
...
(419, 'Brenda Ramos Onofre ', NULL, NULL, NULL, 'brendaaudit@hotmail.com', 'Felix100', '2023-11-16 14:02:26', 'NULL', NULL, '2023-11-16 14:03:24', 1, 0, 1),
...
(445, 'Alexis Graullera Vázquez ', NULL, NULL, NULL, 'kardon_555@hotmail.com', 'Tazapizarron', '2023-11-21 18:57:56', 'NULL', NULL, '2023-11-21 18:59:24', 1, 0, 0),
(446, 'Liliana ', NULL, NULL, NULL, 'jessly2018@yahoo.com', 'AA2023', '2023-11-21 23:53:46', 'NULL', NULL, '2023-11-21 23:54:17', 1, 0, 0),
(447, 'Katia Vanessa Lobato Montoya ', NULL, NULL, NULL, 'kkatyvane@gmail.com', 'bocchi', '2023-11-22 02:12:05', 'NULL', NULL, '2023-11-22 02:12:40', 1, 0, 0),
(448, 'Thalia Estévez ', NULL, NULL, NULL, 'valeriathaliaperezestevez@gmail.com', 'boster21', '2023-11-22 05:21:40', 'NULL', NULL, '2023-11-22 05:22:18', 1, 0, 0),
(449, 'Edna alba', NULL, NULL, NULL, 'ednaalbamorales@gmail.com', 'japo10.', '2023-11-22 08:40:51', 'NULL', NULL, '2023-11-22 08:41:24', 1, 0, 0),
(450, 'Samantha Betel ', NULL, NULL, NULL, 'martinezrosalessamantha@gmail.com', 'Irmayolanda1', '2023-11-22 09:51:41', 'NULL', NULL, '2023-11-22 09:52:45', 1, 0, 0),
(451, 'Gustavo Martínez García ', NULL, NULL, NULL, 'gustavo.mtz.df@gmail.com', 'Tohru1999', '2023-11-22 19:15:09', 'NULL', NULL, '2023-11-27 23:49:01', 1, 0, 0),
(452, 'Gustavo Martínez García ', NULL, NULL, NULL, 'keidefe@gmail.com', NULL, '2023-11-22 19:22:49', '3015', NULL, NULL, 0, 0, 0),
(453, 'Diney Valerio ', NULL, NULL, NULL, 'dineh.valerio@gmail.com', NULL, '2023-11-22 20:53:44', '0988', NULL, NULL, 0, 0, 0),
(454, 'Diney Valerio ', NULL, NULL, NULL, 'diney.valerio@gmail.com', NULL, '2023-11-22 20:54:43', '3979', NULL, NULL, 0, 0, 0),
(457, 'Yulmha ', NULL, NULL, NULL, 'mendezpbp@gmail.com', NULL, '2023-11-23 03:08:00', '3198', NULL, NULL, 0, 0, 0),
(458, 'Miguel Lara Eseiza', NULL, NULL, NULL, 'thebunnykingdommx@gmail.com', '223322', '2023-11-23 03:27:45', 'NULL', NULL, '2023-11-23 07:29:50', 1, 0, 0),
(459, 'Diana herrera', NULL, NULL, NULL, 'dyiana_mathdoors@hotmail.com', '120502', '2023-11-23 18:13:11', 'NULL', NULL, '2023-11-23 18:13:56', 1, 0, 0),
(460, 'ariana Tapia', NULL, NULL, NULL, 'usagiari12@gmail.com', 'Copito1204', '2023-11-23 18:29:51', 'NULL', NULL, '2023-11-23 18:32:58', 1, 0, 0),
(461, 'Karem Marín ', NULL, NULL, NULL, 'senekismarin@gmail.com', '131992', '2023-11-23 18:36:05', 'NULL', NULL, '2023-11-23 18:36:38', 1, 0, 0),
(462, 'Diana Evelyn ', NULL, NULL, NULL, 'minsung.13.mv6@gmail.com', 'quesito13', '2023-11-23 21:58:20', 'NULL', NULL, '2023-11-23 21:58:54', 1, 0, 0),
(463, 'Emilia Ángela Fierro González ', NULL, NULL, NULL, 'emilia00p2@gmail.com', NULL, '2023-11-24 08:21:27', '8653', NULL, NULL, 0, 0, 0),
(464, 'Gustavo Hernandez Fajardo', NULL, NULL, NULL, 'fugtr20@hotmail.com', 'Purasburradas.', '2023-11-24 11:24:24', 'NULL', NULL, '2023-11-24 11:25:14', 1, 0, 0),
(465, 'Frida Sánchez ', NULL, NULL, NULL, 'fridass5@outlook.com', 'kikis200262', '2023-11-24 17:27:41', 'NULL', NULL, '2023-11-24 17:28:20', 1, 0, 0),
(466, 'Emilia Fierro', NULL, NULL, NULL, 'e_stay_09@naver.com', 'straykidsJ8', '2023-11-24 19:58:37', 'NULL', NULL, '2023-11-24 19:59:16', 1, 0, 0),
(467, 'Lina Suarez ', NULL, NULL, NULL, 'Lina91185@hotmail.com', 'Lina1185', '2023-11-25 02:15:04', 'NULL', NULL, '2023-11-25 02:15:44', 1, 0, 0),
(468, 'Dolores Adriana Nolasco ', NULL, NULL, NULL, 'adriana8898@gmail.com', '121105As', '2023-11-26 10:40:49', 'NULL', NULL, '2023-11-26 10:41:35', 1, 0, 0),
(469, 'Jessica Yadira flores Álvarez ', NULL, NULL, NULL, 'jessyflo7@gmail.com', '250406', '2023-11-26 20:37:50', 'NULL', NULL, '2023-11-26 20:38:15', 1, 0, 0),
(470, 'Mishell Robredo', NULL, NULL, NULL, 'saltodelconejo@gmail.com', '181823', '2023-11-27 14:45:08', 'NULL', NULL, '2023-11-27 14:45:40', 1, 0, 0),
(471, 'Cecilia Blancas Juárez ', NULL, NULL, NULL, 'cecyblanju29@gmail.com', '291029', '2023-11-27 15:19:56', 'NULL', NULL, '2023-11-27 15:22:53', 1, 0, 0),
(472, 'Grisel', NULL, NULL, NULL, 'seltran@hotmail.com', 'checot09', '2023-11-27 15:37:21', 'NULL', NULL, '2023-11-27 15:38:49', 1, 0, 0),
(473, 'Yolanda Pineda', NULL, NULL, NULL, 'yola_chan@hotmail.com', 'MisConejitos02', '2023-11-27 19:20:57', 'NULL', NULL, '2023-11-27 19:26:08', 1, 0, 0),
(474, 'Jessica Hoyos', NULL, NULL, NULL, 'jessie_hoa@hotmail.com', 'Jyj07097', '2023-11-28 20:59:28', 'NULL', NULL, '2023-11-28 21:00:13', 1, 0, 0),
(475, 'Ailyn Arteaga ', NULL, NULL, NULL, 'aliferta31@gmail.com', '04051031', '2023-11-29 07:45:08', 'NULL', NULL, '2023-11-29 07:46:05', 1, 0, 0),
(476, 'Alfredo', NULL, NULL, NULL, 'axelAA@gmail.com', NULL, '2023-11-30 13:57:33', '2142', NULL, NULL, 0, 0, 0),
(477, 'Fernando Martinez', NULL, NULL, NULL, 'fmartinez.andrade0@gmail.com', 'Haru300421', '2023-11-30 13:59:24', 'NULL', NULL, '2023-11-30 14:32:16', 1, 0, 0),
(478, '', NULL, NULL, NULL, 'aespinas@gmail.com', NULL, '2023-11-30 14:59:17', '6238', NULL, NULL, 0, 0, 0),
(479, 'Ofelia Hoyos Gonzalez', NULL, NULL, NULL, 'luna.gonzalez.ofe@gmail.com', 'valeyu6022002', '2023-11-30 15:01:48', 'NULL', NULL, '2023-11-30 15:02:36', 1, 0, 0),
(480, 'Edith Michelle Rosas Arriaga ', NULL, NULL, NULL, 'edith.rosas33@my.unitec.edu.mx', NULL, '2023-11-30 17:33:57', '5226', NULL, NULL, 0, 0, 0),
(481, 'Manuel gonzalez ', NULL, NULL, NULL, 'manuel131297@gmail.com', '121105As', '2023-11-30 18:26:46', 'NULL', NULL, '2023-11-30 18:27:23', 1, 0, 0),
(482, 'Aimee gonzalez ', NULL, NULL, NULL, 'peque201214@gmail.com', '121105As', '2023-11-30 18:45:56', 'NULL', NULL, '2023-11-30 23:47:33', 1, 0, 0),
(483, 'Roberto Hernandez', NULL, NULL, NULL, 'robert_82_26@hotmail.com', 'Lula2608', '2023-11-30 19:58:55', 'NULL', NULL, '2023-11-30 19:59:46', 1, 0, 0),
(484, 'Andrea Taylor ', NULL, NULL, NULL, 'andrea.taylor.munguia@gmail.com', 'Diosesmipastor94', '2023-11-30 20:51:28', 'NULL', NULL, '2023-11-30 20:52:11', 1, 0, 0),
(485, 'Jack Pérez Castellano', NULL, NULL, NULL, 'jackbullys98@gmail.com', NULL, '2023-12-01 00:40:37', '3526', NULL, NULL, 0, 0, 0),
(486, 'Dulce Alejandra Acosta Sánchez ', NULL, NULL, NULL, 'asda.p9.fm@outlook.com', '23Diosenmi', '2023-12-01 11:13:56', 'NULL', NULL, '2023-12-01 11:15:08', 1, 0, 0),
(487, 'Ruth Minerva Mayén Alcántara ', NULL, NULL, NULL, 'mvz.ruthmayen@gmail.com', NULL, '2023-12-01 14:05:40', '9050', NULL, NULL, 0, 0, 0),
(488, 'María Luisa Sampallo Pedraza ', NULL, NULL, NULL, 'sampallo1976@gmail.com', '091976', '2023-12-01 15:53:29', 'NULL', NULL, '2023-12-01 15:55:24', 1, 0, 0),
(489, 'Rosalba Avalos Alarcon ', NULL, NULL, NULL, 'avalosr44@hotmail.com', 'rowito', '2023-12-01 16:30:46', 'NULL', NULL, '2023-12-01 16:32:06', 1, 0, 0),
(490, 'Sandra Moreno', NULL, NULL, NULL, 'sandi970709@gmail.com', NULL, '2023-12-01 16:44:58', '8807', NULL, NULL, 0, 0, 0),
(491, 'Fabiola Rocío Salas Lechuga ', NULL, NULL, NULL, 'fabiolasalas1986@gmail.com', 'Perrita69', '2023-12-01 16:49:48', 'NULL', NULL, '2023-12-02 02:49:35', 1, 0, 0),
(492, 'Karen Lorena Mejia Sánchez ', NULL, NULL, NULL, 'kmejia.sanchez92@gmail.com', '123456', '2023-12-01 17:13:00', 'NULL', NULL, '2023-12-01 17:13:45', 1, 0, 0),
(493, 'Fernando Casales Salazar ', NULL, NULL, NULL, 'pollo_fercho@hotmail.com', 'Rabita01', '2023-12-01 17:26:38', 'NULL', NULL, '2023-12-01 19:39:12', 1, 0, 0),
(494, 'Viridiana Avila Bello ', NULL, NULL, NULL, 'avilabelloviridiana@gmail.com', 'Aiko2011', '2023-12-01 19:26:23', 'NULL', NULL, '2023-12-01 19:29:06', 1, 0, 0),
(495, 'Yocelyn Guadalupe Olvera García ', NULL, NULL, NULL, 'yocelyn.olvera@hotmail.com', 'Yoce1390', '2023-12-01 20:01:16', 'NULL', NULL, '2023-12-01 20:02:09', 1, 0, 0),
(496, 'Juan Carlos', NULL, NULL, NULL, 'zeta_ciber9@hotmail.com', '240909', '2023-12-01 20:57:50', 'NULL', NULL, '2023-12-01 20:58:48', 1, 0, 0),
(497, 'Irma Saucedo ', NULL, NULL, NULL, 'andrianoirma@gmail.com', '197124', '2023-12-01 22:10:25', 'NULL', NULL, '2023-12-01 22:11:40', 1, 0, 0),
(498, 'María Gariel ', NULL, NULL, NULL, 'garfu00@gmail.com', 'Cheshire.2', '2023-12-01 23:07:54', 'NULL', NULL, '2023-12-01 23:08:21', 1, 0, 0),
(499, 'Enrique Alfonso Macias Espinosa', NULL, NULL, NULL, 'eame1994@gmail.com', 'eamexd0p', '2023-12-02 00:12:13', 'NULL', NULL, '2023-12-02 00:12:33', 1, 0, 0),
(500, 'ITZEL VALDES MARTINEZ', NULL, NULL, NULL, 'itzel0503_05@hotmail.com', 'Shashos8223', '2023-12-02 00:27:18', 'NULL', NULL, '2023-12-02 00:28:26', 1, 0, 0),
(501, 'Carolina Sotelo ', NULL, NULL, NULL, 'krolina_94@hotmail.com', NULL, '2023-12-02 06:52:17', '6801', NULL, NULL, 0, 0, 0),
(502, 'Líssette Molina ', NULL, NULL, NULL, 'nadykawaii2011@gmail.com', 'Lissette1', '2023-12-02 10:01:15', 'NULL', NULL, '2023-12-02 10:03:02', 1, 0, 0),
(503, 'Antonio Molina', NULL, NULL, NULL, 'lanenachiquita@hotmail.com', 'Antonio1', '2023-12-02 10:07:13', 'NULL', NULL, '2023-12-02 10:10:45', 1, 0, 0),
(504, 'Antonio Molina', NULL, NULL, NULL, 'teboyfaby@hotmail.com', 'Chiofaby1982', '2023-12-02 10:11:23', 'NULL', NULL, '2023-12-02 10:12:19', 1, 0, 0),
(505, 'José Luis Mora Hernández ', NULL, NULL, NULL, 'moradozh2468@gmail.com', 'Burbuj@2020', '2023-12-02 10:38:49', 'NULL', NULL, '2023-12-02 10:49:38', 1, 0, 0),
(506, 'Michelle Camila Gallegos Bravo ', NULL, NULL, NULL, 'lutthmila@gmail.com', '72248', '2023-12-02 10:50:16', 'NULL', NULL, '2023-12-02 10:52:23', 1, 0, 0),
(507, 'Edith', NULL, NULL, NULL, 'saactaledith420@gmail.com', 'Soja1704', '2023-12-02 12:18:16', 'NULL', NULL, '2023-12-02 12:18:46', 1, 0, 0),
(508, 'Zarasuadi Chávez Smith', NULL, NULL, NULL, 'smith020100@gmail.com', 'Lieben', '2023-12-02 13:48:31', 'NULL', NULL, '2023-12-02 13:49:15', 1, 0, 0),
(509, 'Jessica flores ortega', NULL, NULL, NULL, 'jeskarlos@hotmail.com', 'mamita9', '2023-12-02 13:57:26', 'NULL', NULL, '2023-12-02 14:03:34', 1, 0, 0),
(510, 'Fabiola Rosas Garcia', NULL, NULL, NULL, 'Fr7593100@gmail.com', 'Carlitos97', '2023-12-02 17:16:14', 'NULL', NULL, '2023-12-02 17:17:05', 1, 0, 0),
(511, 'Viridiana Zambrano Angel ', NULL, NULL, NULL, 'virizambano@hotmail.com', NULL, '2023-12-02 19:14:54', '6280', NULL, NULL, 0, 0, 0),
(512, 'Obed', NULL, NULL, NULL, 'herediaobed.derecho@gmail.com', 'Zanahorya11', '2023-12-02 19:25:13', 'NULL', NULL, '2023-12-04 08:41:16', 1, 0, 0),
(513, 'Mark Calderón ', NULL, NULL, NULL, 'mark2012uwu@gmail.com', '201202', '2023-12-02 19:52:59', 'NULL', NULL, '2023-12-02 19:53:21', 1, 0, 0),
(514, 'Derek Juarez patlani', NULL, NULL, NULL, 'derek_patlani@outlook.com', 'Lepug009', '2023-12-02 19:54:35', 'NULL', NULL, '2023-12-02 19:55:09', 1, 0, 0),
(515, 'Liz', NULL, NULL, NULL, 'lizgrife@gmail.com', 'ConejonHope', '2023-12-02 20:04:21', 'NULL', NULL, '2023-12-02 20:05:06', 1, 0, 0),
(516, 'Mariana Diaz ', NULL, NULL, NULL, 'marianamdiazh97@gmail.com', 'Aa13534966!', '2023-12-02 20:04:44', 'NULL', NULL, '2023-12-02 20:05:15', 1, 0, 0),
(517, 'María Luisa Herrera ', NULL, NULL, NULL, 'bluemayu1407@gmail.com', '141407', '2023-12-02 21:46:12', 'NULL', NULL, '2023-12-02 21:46:49', 1, 0, 0),
(518, 'Christian Cornejo Hernandez', NULL, NULL, NULL, 'christian.cornejo@outlook.com', 'bombon', '2023-12-02 21:53:18', 'NULL', NULL, '2023-12-02 21:54:25', 1, 0, 0),
(519, 'Raymundo Casas', NULL, NULL, NULL, 'raymundo.casas.c@gmail.com', 'Alucard0', '2023-12-02 21:59:11', 'NULL', NULL, '2023-12-02 21:59:41', 1, 0, 0),
(520, 'Beatriz Guadalupe Benitez Medina', NULL, NULL, NULL, 'bemb2802@gmail.com', 'bombon', '2023-12-02 22:02:24', 'NULL', NULL, '2023-12-02 22:03:01', 1, 0, 0),
(521, 'Luis Humberto Gallegos Elvira', NULL, NULL, NULL, 'humberto_198132@hotmail.com.com', NULL, '2023-12-02 22:09:50', '1007', NULL, NULL, 0, 0, 0),
(522, 'Luis Humberto Gallegos Elvira', NULL, NULL, NULL, 'humberto_198132@hotmail.com', 'luis0807', '2023-12-02 22:11:34', 'NULL', NULL, '2023-12-02 22:12:05', 1, 0, 0),
(523, 'Maria Fernanda Alvarez Silva ', NULL, NULL, NULL, 'fernandaalvarez164kz@gmail.com', '1615', '2023-12-02 22:48:31', 'NULL', NULL, '2023-12-02 22:49:12', 1, 0, 0),
(524, 'Ilce magaly Vázquez padilla', NULL, NULL, NULL, 'evangelion_apocrifo@hotmail.com', '1234567890', '2023-12-02 23:04:40', 'NULL', NULL, '2023-12-02 23:05:39', 1, 0, 0),
(525, 'Kevin Alejandro Hernández Ramos', NULL, NULL, NULL, 'notemetasconwoojin@gmail.com', '1616', '2023-12-02 23:36:25', 'NULL', NULL, '2023-12-02 23:36:52', 1, 0, 0),
(526, 'Lily', NULL, NULL, NULL, 'psicpumalily@hotmail.com', NULL, '2023-12-02 23:45:27', '4284', NULL, NULL, 0, 0, 0),
(527, 'Ana Lilia Ruiz Aguilar ', NULL, NULL, NULL, 'analilia.ruiz20@gmail.com', 'ranita', '2023-12-02 23:51:29', 'NULL', NULL, '2023-12-02 23:52:38', 1, 0, 0),
(528, 'Abigail Perez', NULL, NULL, NULL, 'abi.ago08@gmail.com', 'Rafael9508', '2023-12-03 08:07:58', 'NULL', NULL, '2023-12-03 08:08:35', 1, 0, 0),
(529, 'Lilia Rodríguez ', NULL, NULL, NULL, 'limaroma1966@gmail.com', 'Soyperro8', '2023-12-03 09:29:08', 'NULL', NULL, '2023-12-03 09:29:43', 1, 0, 0),
(530, 'Beatriz', NULL, NULL, NULL, 'bdelavegamx@gmail.com', NULL, '2023-12-03 11:39:28', '7087', NULL, NULL, 0, 0, 0),
(531, 'Monserrat barranco Alvarado ', NULL, NULL, NULL, 'estefanymonserrat015@gmail.com', 'monxica', '2023-12-03 11:58:07', 'NULL', NULL, '2023-12-03 11:58:52', 1, 0, 0),
(532, 'JULIO CESAR DE LA CRUZ CORTEZ', NULL, NULL, NULL, 'julio_cdc@outlook.com', 'brunero01', '2023-12-03 15:00:31', 'NULL', NULL, '2023-12-03 17:00:53', 1, 0, 0),
(533, 'Nadia soto', NULL, NULL, NULL, 'nadiiasoto06@gmail.con', NULL, '2023-12-03 15:26:56', '9776', NULL, NULL, 0, 0, 0),
(534, 'Nadia Soto ', NULL, NULL, NULL, 'nadiiasoto06@gmail.com', 'Paulina23', '2023-12-03 15:29:07', 'NULL', NULL, '2023-12-03 15:30:38', 1, 0, 0),
(535, 'Orlando Aparicio Mondragon ', NULL, NULL, NULL, 'ladequesosinsalsa@gmail.com', 'conejon666', '2023-12-03 17:01:43', 'NULL', NULL, '2023-12-03 17:02:21', 1, 0, 0),
(536, 'Carla velasquez', NULL, NULL, NULL, 'carlavelasquez069@gmail.com', NULL, '2023-12-03 19:00:00', '1435', NULL, NULL, 0, 0, 0),
(537, 'Paulina Barrera Garduño ', NULL, NULL, NULL, 'paulinushca@hotmail.com', 'Colmillos320', '2023-12-03 19:24:13', 'NULL', NULL, '2023-12-03 19:25:07', 1, 0, 0),
(538, 'Tania', NULL, NULL, NULL, 'tanylizeth006@gmail.com', 'Tania0929', '2023-12-03 22:01:32', 'NULL', NULL, '2023-12-03 22:02:29', 1, 0, 0),
(539, 'Fernando camacho', NULL, NULL, NULL, 'fernandocamacholeyva@hotmail.com', '151130', '2023-12-03 22:29:20', 'NULL', NULL, '2023-12-03 22:30:14', 1, 0, 0),
(540, 'Maria de Jesus Martinez', NULL, NULL, NULL, 'osyma_23@hotmail.com', NULL, '2023-12-04 07:29:05', '4724', NULL, NULL, 0, 0, 0),
(541, 'Valeria Irais Romero', NULL, NULL, NULL, 'djn0622o@dee.edu.mx', '231199', '2023-12-04 07:30:56', 'NULL', NULL, '2023-12-04 07:34:48', 1, 0, 0),
(542, 'Pamela Martínez Peralta ', NULL, NULL, NULL, 'pimpi1705@gmail.com', '170502', '2023-12-04 09:40:59', 'NULL', NULL, '2023-12-04 09:42:10', 1, 0, 0),
(543, 'Emmanuel ', NULL, NULL, NULL, 'emmanuelpulido2001@gmail.com', '201813', '2023-12-04 10:06:41', 'NULL', NULL, '2023-12-04 10:07:06', 1, 0, 0),
(544, 'Concepcion monterrubio ', NULL, NULL, NULL, 'conyham81@gmail.com.mx', NULL, '2023-12-04 15:52:17', '8713', NULL, NULL, 0, 0, 0),
(545, 'Concepcion monterrubio ', NULL, NULL, NULL, 'conyham81@gmail.com.mxx', NULL, '2023-12-04 15:53:03', '3706', NULL, NULL, 0, 0, 0),
(546, 'Valeria Irais', NULL, NULL, NULL, 'mariibalmar@gmail.com', '231199', '2023-12-04 19:15:41', 'NULL', NULL, '2023-12-04 19:16:02', 1, 0, 0),
(547, 'Johanna Jalil Romero Martinez', NULL, NULL, NULL, 'balderasmari231199@gmail.com', '231199', '2023-12-04 19:17:46', 'NULL', NULL, '2023-12-04 19:18:11', 1, 0, 0),
(548, 'Maria de Jesus Martinez Balderas', NULL, NULL, NULL, 'maria.fernanda.omemartinez@bggem.mx', '231199', '2023-12-04 19:20:51', 'NULL', NULL, '2023-12-04 19:21:12', 1, 0, 0),
(549, 'Juan Salvador Romero Arellano', NULL, NULL, NULL, 'jsr1_gaviota@hotmail.com', '2311', '2023-12-04 19:44:01', 'NULL', NULL, '2023-12-04 19:46:25', 1, 0, 0),
(550, 'Guadalupe ', NULL, NULL, NULL, 'gm5549141@gmail.com', 'Guadalupe2001', '2023-12-04 22:44:29', 'NULL', NULL, '2023-12-04 22:45:11', 1, 0, 0),
(551, 'Daniel Alberto Márquez Aviles', NULL, NULL, NULL, 'danieru0108937@gmail.com', 'Rebata0715', '2023-12-05 08:11:07', 'NULL', NULL, '2023-12-05 08:30:46', 1, 0, 0),
(552, 'Cinthia Navarro ', NULL, NULL, NULL, 'cinthianavarro353@gmail.com', 'navarro353', '2023-12-05 10:36:54', 'NULL', NULL, '2023-12-05 10:37:28', 1, 0, 0),
(553, 'Paulina Rivera Jiménez ', NULL, NULL, NULL, 'pausriv@gmail.com', 'pajolu116', '2023-12-05 11:04:16', 'NULL', NULL, '2023-12-05 11:04:49', 1, 0, 0),
(554, 'Analuci Medina', NULL, NULL, NULL, 'analuci.medina08@gmail.com', '#An16828485', '2023-12-05 13:44:15', 'NULL', NULL, '2023-12-05 13:45:31', 1, 0, 0),
(555, 'Ricardo Barrera', NULL, NULL, NULL, 'gothrichie@hotmail.com', 'dimitri13', '2023-12-05 15:14:15', 'NULL', NULL, '2023-12-05 15:15:57', 1, 0, 0),
(556, 'Massiel', NULL, NULL, NULL, 'massielmejia99@gmail.com', '260695', '2023-12-05 17:46:07', 'NULL', NULL, '2023-12-05 17:47:43', 1, 0, 0),
(557, 'Liliana', NULL, NULL, NULL, 'lilimondra0212@gmail.com', 'koda', '2023-12-05 19:50:27', 'NULL', NULL, '2023-12-05 19:50:55', 1, 0, 0),
(558, 'Diego Germán Sandoval Rosas ', NULL, NULL, NULL, 'diegosandovalgr282@gmail.com', '318343', '2023-12-05 20:12:12', 'NULL', NULL, '2023-12-05 20:12:34', 1, 0, 0),
(559, 'SARA ABAUNZA', NULL, NULL, NULL, 'abaun.sa@gmail.com', '4esz4rfv', '2023-12-05 20:14:02', 'NULL', NULL, '2023-12-05 20:16:48', 1, 0, 0),
(560, 'Maximiliano Román Sanchez', NULL, NULL, NULL, 'maximilianoromansanchez3@gmail.com', 'Burbuj@2020', '2023-12-05 20:18:42', 'NULL', NULL, '2023-12-05 20:19:23', 1, 0, 0),
(561, 'Olga Pérez Zúñiga ', NULL, NULL, NULL, 'olgapzuniga@gmail.com', '24981149Rc', '2023-12-05 20:57:09', 'NULL', NULL, '2023-12-05 20:57:50', 1, 0, 0);
...
--
-- Indices de la tabla `CAT_mediosContacto`
--
ALTER TABLE `CAT_mediosContacto`
  ADD PRIMARY KEY (`id`);
...
--
-- Indices de la tabla `CAT_tipoEnvio`
--
ALTER TABLE `CAT_tipoEnvio`
  ADD PRIMARY KEY (`id`);

--
-- Indices de la tabla `CAT_tipoPedido`
--
ALTER TABLE `CAT_tipoPedido`
  ADD PRIMARY KEY (`id`);

--
-- Indices de la tabla `contactotiendas`
--
ALTER TABLE `contactotiendas`
  ADD PRIMARY KEY (`id`);
...
--
-- Indices de la tabla `metodosdepagotienda`
--
ALTER TABLE `metodosdepagotienda`
  ADD PRIMARY KEY (`id`);
...
--
-- Indices de la tabla `reputacionTienda`
--
ALTER TABLE `reputacionTienda`
  ADD PRIMARY KEY (`id`);

--
-- Indices de la tabla `sucursalesTienda`
--
ALTER TABLE `sucursalesTienda`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT de la tabla `categoriasTienda`
--
ALTER TABLE `categoriasTienda`
...
--
-- AUTO_INCREMENT de la tabla `CAT_mediosContacto`
--
ALTER TABLE `CAT_mediosContacto`
...
--
-- AUTO_INCREMENT de la tabla `CAT_tipoEnvio`
--
ALTER TABLE `CAT_tipoEnvio`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `CAT_tipoPedido`
--
ALTER TABLE `CAT_tipoPedido`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT de la tabla `contactotiendas`
--
ALTER TABLE `contactotiendas`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT de la tabla `metodosdepagotienda`
--
ALTER TABLE `metodosdepagotienda`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT de la tabla `reputacionTienda`
--
ALTER TABLE `reputacionTienda`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;

--
-- AUTO_INCREMENT de la tabla `sucursalesTienda`
--
ALTER TABLE `sucursalesTienda`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
