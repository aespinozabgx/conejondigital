            ...
            <div id="layoutDefault_content">
                <main>
                                                ...
                                                <div class="col-lg-7 p-lg-5">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-6">
                                                            ...
                                                            <h6 class="dropdown-header text-primary">Habitad</h6>
                                                            <a class="dropdown-item" href="#">Subcategoría</a>
                                                            <a class="dropdown-item" href="#">Subcategoría</a>
                                                            <div class="dropdown-divider border-0"></div>
                    ...
                    <header class="page-header-ui page-header-ui-light bg-img-cover" style="background-image: url('assets/img/landing-5.jpg')">
                        ...
                        <div class="svg-border-rounded"  style="color: #FF9AA2;">
                            <!-- Rounded SVG Border-->
                    ...
                    <section class="py-10" style="background-color: #FF9AA2;">
                        <div class="container px-5" id="evento">
                            <div class="row gx-5 justify-content-center">
                                <div class="col-lg-6">
                                    <div class="mb-5 text-center" data-aos="fade-up">
                                        <div class="display-6 f-bebas fw-400 text-uppercase text-white mb-2">FALTAN</div>
                                        <p id="salidaContador" class="f-bangers display-3" style="color: #E2F0CB; text-shadow: 2px 2px 0px #7c8075;"></p>
                                        <p class="lead text-white mb-0">Para el conejón Navideño 2023</p>
                                    </div>

                                    
                                    <script>
                                        // Set the date we're counting down to
                                        var countDownDate = new Date("Dec 14, 2023 15:00:00").getTime();
                                        ...
                                        var x = setInterval(function() 
                                        {
                                            ...
                                            document.getElementById("salidaContador").innerHTML = days + "d " + hours + "h "
                                            + minutes + "m " + seconds + "s ";
                                            ...
                                            {
                                                clearInterval(x);
                                                document.getElementById("salidaContador").innerHTML = "¡ES HOY!";
                                            }
                                        }, 1000);
                                    </script>
                            ...
                            <div class="row gx-5 justify-content-center">
                                ...
                                <div class="col-md-6 col-lg-4 col-xl-3 mb-5" data-aos="fade-up">
                                ...
                                <div class="col-md-6 col-lg-4 col-xl-3 mb-5 mb-lg-0" data-aos="fade-up">
                                    <a class="card lift bg-white" href="#!">
                                        <img class="card-img-top" src="assets/img/evento/habitad.jpg" alt="..." />
                                        <div class="card-body text-center py-3"><h6 class="card-title text-pink f-poppins mb-0">Habitad</h6></div>
                                    </a>
                                </div>
                                <div class="col-md-6 col-lg-4 col-xl-3 mb-5 mb-lg-0" data-aos="fade-up">
                                    <a class="card lift bg-white" href="#!">
                                ...
                                <div class="col-md-6 col-lg-4 col-xl-3 mb-5 mb-md-0" data-aos="fade-up">
                                    <a class="card lift bg-white" href="#!">
                    ...
                    <section class="pt-5 pb-10 bg-white">
                        ...
                        <div class="container px-5">
                            <div class="bg-blue card mt-n15 shadow-sm mb-0 z-1 border border-0" style="background-color: #FFDAC1;">
                                <div class="card-body p-5">
                                    <div class="row gx-5 align-items-center">
                                        <div class="col-lg-6">
                                            <h1 class="text-white"><i class="fas fa-bullhorn fa-rotate-by fa-lg" style="--fa-rotate-angle: -30deg;"></i> Atención Expositores</h1>
                                            <p class="lead text-white mb-3">Realiza tu pre registro y consigue tu lugar en el Conejón Navideño 2023 y en la tienda en línea oficial del Conejón</p>
                                        </div>
                                        <div class="col-lg-6">
                                            <form action="">
                            ...
                            <div class="row gx-5 justify-content-center">
                                <div class="col-lg-8">
                                    <div class="text-center mb-10">
                                        ...
                                        <div class="f-bebas display-1" style="color: #FFB7B2; text-shadow: 2px 2px 0px rgba(165, 90, 90, 0.653);">🛍️ Tienda en línea </div>
                                        <p class="lead text-yellow fs-2">¡Encuentra todo para tus peluditos en la Tienda Oficial del Conejón!</p>
                                    </div>
                                </div>
                            </div>
